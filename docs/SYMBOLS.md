...
database reports 11,271 total functions, 9,187 with names, and 2,084 default
`sub_` names. Those figures describe the IDA database; the 8,601 count
describes the reproducible symbol import and rename pass. The 27 semantic labels
...
| IDA default `sub_` names | 2,084 |
| Named by IDA but not backed by an ELF record | 1,091 |
