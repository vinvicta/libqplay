...
8,096 function starts and the remaining rows are 2,086 default `sub_` names
plus 1,089 names that IDA created without a matching ELF symbol. The 505
...
A focused follow-up pass did recover reliable behavior names for 25 of those
