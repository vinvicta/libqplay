...
rename the constant pools. A later hygiene revision will remove the two
phantom function boundaries and define four 16-byte data items at each
location, then reopen the database to confirm that the function inventory no
longer counts data as code.
