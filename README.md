...
`analysis/spectron_libqplay_translated_v234.i64`. The newest pass recovers the
missing target function boundary for the `tclient_setplayerhurt` property
callback and applies the reviewed alias
