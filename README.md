...
`analysis/spectron_libqplay_translated_v227.i64`. The newest pass adds two
high-confidence aliases for the text-list selection script methods. Their
target bodies preserve the source selection branches while adding one wrapper
instruction each. The reopened v227 copy has 11,694 functions and 1,091
