...
`analysis/spectron_libqplay_translated_v228.i64`. The newest pass adds four
exact aliases for the residual MRandomGenerator seed property and random
number script callbacks. The source and target property-table records agree,
and every recorded feature metric matches. The reopened v228 copy has 11,694
functions and 1,087 remaining default `sub_` names. Its SHA-256 is
