...
`analysis/spectron_libqplay_translated_v226.i64`. The newest pass adds one
exact high-confidence alias for the residual `GuiProgressCtrl` progress
getter. The reopened v226 copy has 11,694 functions and 1,093 remaining
...
generated by `tools/generate_spectron_gui_progress_getter_anchor.py`, and the
v226 checkpoint is
