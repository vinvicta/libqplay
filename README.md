...
`analysis/spectron_libqplay_translated_v230.i64`. The newest pass adds five
high-confidence aliases in the TClient script-property table. They cover
download-size state, server-list connection completion, flag-data wrappers,
and active-player weapon updates. The reopened v230 copy has 11,694
functions and 1,079 remaining default `sub_` names. Its SHA-256 is
