#!/usr/bin/env python3
"""Create the v342 checkpoint for the residual TInput modifier accessors."""
...
ARTIFACT = "spectron_translation_checkpoint_20260829_v342"
PARENT_ARTIFACT = "spectron_translation_checkpoint_20260829_v341"
EXPECTED_BINARY_SHA256 = "f57f7da48bcddf3738f15502328b36032313ad760eea04c5cc19ef82b4232219"
EXPECTED_PARENT_DATABASE_SHA256 = "f892d0eb81a79a242c41aeb19742dc33693863fd0373217727d2bba154d33d73"
EXPECTED_DATABASE_SHA256 = "ec767e7a86e12b169f0053d4d1b783aa01fc8b7efa90863b69912553aa451ae7"
EXPECTED_ANCHOR_ARTIFACT = "spectron_input_modifiers_residual_manual_translation_anchors_20260829"
...
EXPECTED_ALIASES = [
    "v18_TInput_getShiftKeyState_void",
    "v18_TInput_getControlKeyState_void",
    "v18_TInput_getAltKeyState_void",
]
EXPECTED_TARGETS = ["0x16c9f0", "0x16ca24", "0x16ca58"]
EXPECTED_NAME_ORIGINS = {
    "ida_named_or_other": 4052,
    "target_jni_export": 7,
    "target_named_export": 797,
    "target_only_descriptive": 419,
    "translated_v18_alias": 6432,
}
EXPECTED_DYNAMIC_SUMMARY = {
    ...
    "name_match_counts": {
        "item_name_match": 1685,
        "item_name_mismatch": 5085,
        "value_name_match": 1685,
        "value_name_mismatch": 5085,
    },
    "named_dynamic_symbol_count": 6770,
    "status_counts": {
        "exact_retained_dynamic_name": 1685,
        "linker_boundary_alias_mismatch": 7,
        "other_retained_target_name": 120,
        "source_backed_v18_alias": 4786,
...
def main() -> None:
    ...
    require(parent["database"]["sha256"] == EXPECTED_PARENT_DATABASE_SHA256, "parent database hash is not v341")
    require(anchors.get("artifact") == EXPECTED_ANCHOR_ARTIFACT, "unexpected input-modifier anchor artifact")
    require(anchors.get("network_contacted") is False, "input-modifier anchors contacted the network")
    require(anchors.get("summary") == EXPECTED_ANCHOR_SUMMARY, "input-modifier anchor summary changed")
    require([row["proposed_name"] for row in anchors["anchors"]] == EXPECTED_ALIASES, "input-modifier alias order changed")
    require([row["spectron_ea"] for row in anchors["anchors"]] == EXPECTED_TARGETS, "input-modifier target order changed")
    require(
        ...
        "input-modifier alias application did not pass",
    )
    require(
        ...
        "input-modifier alias reopen verification did not pass",
    )
    require(
    ...
    require(
        ...
        "v342 dynamic boundary audit changed",
    )
    require(
        ...
        "v342 dynamic symbol coverage changed",
    )
    require(
        ...
        "v342 semantic map changed",
    )
    require(feature_export.get("function_count") == 11707, "v342 feature export count changed")
    require(args.database.is_file(), "database path is not a regular file")
    database_sha256 = sha256_path(args.database)
    require(database_sha256 == EXPECTED_DATABASE_SHA256, "v342 database hash changed")
    ...
    result["inputs"] = {
        **parent.get("inputs", {}),
        "v342_input_modifiers_anchor_artifact": str(args.anchor_artifact),
        "v342_input_modifiers_anchor_artifact_sha256": sha256_path(args.anchor_artifact),
        "v342_input_modifiers_application_report": str(args.application_report),
        "v342_input_modifiers_application_report_sha256": sha256_path(args.application_report),
        "v342_input_modifiers_verification_report": str(args.verification_report),
        "v342_input_modifiers_verification_report_sha256": sha256_path(args.verification_report),
        "v342_name_audit": str(args.name_audit),
        "v342_name_audit_sha256": sha256_path(args.name_audit),
        "v342_boundary_audit": str(args.boundary_audit),
        "v342_boundary_audit_sha256": sha256_path(args.boundary_audit),
        "v342_dynamic_symbol_coverage": str(args.dynamic_symbol_coverage),
        "v342_dynamic_symbol_coverage_sha256": sha256_path(args.dynamic_symbol_coverage),
        "v342_semantic_map": str(args.semantic_map),
        "v342_semantic_map_sha256": sha256_path(args.semantic_map),
        "v342_feature_export": str(args.feature_export),
        "v342_feature_export_sha256": sha256_path(args.feature_export),
    }
    result["input_modifiers_translation_v342"] = {
    ...
    result["name_coverage_audit_v342"] = {
    ...
    result["dynamic_function_boundary_audit_v342"] = {
    ...
    result["dynamic_symbol_coverage_audit_v342"] = {
    ...
    result["semantic_function_translation_v342"] = {
    ...
    result["interpretation"].append(
        "The v342 pass adds three reviewed aliases for the TInput shift, control, and alt modifier accessors."
    )
    result["interpretation"].append(
