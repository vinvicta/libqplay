#!/usr/bin/env python3
"""Create the v339 checkpoint for the residual geometry name pass."""
...
ARTIFACT = "spectron_translation_checkpoint_20260829_v339"
PARENT_ARTIFACT = "spectron_translation_checkpoint_20260829_v338"
EXPECTED_BINARY_SHA256 = "f57f7da48bcddf3738f15502328b36032313ad760eea04c5cc19ef82b4232219"
EXPECTED_PARENT_DATABASE_SHA256 = "26584982aa976361088e7978b162d12e1be4bf2bf9991bf9484c56e92bba8c2d"
EXPECTED_DATABASE_SHA256 = "d50a0755bb461dada6b011b4df4ca01f9a0cbaf0112805b0ff1e5ab48764bebe"
EXPECTED_ANCHOR_ARTIFACT = "spectron_geometry_residual_manual_translation_anchors_20260829"
...
EXPECTED_ALIASES = [
    "v18_TFloatRectangle_unionRects_TFloatRectangle_const",
    "v18_TDoubleRectangle_unionRects_TDoubleRectangle_const",
    "v18_TRegion_TRegion_void",
    "v18_TRegion_clear_void",
]
EXPECTED_TARGETS = ["0x1ea7e4", "0x1ea860", "0x1ea8dc", "0x1ea8e4"]
EXPECTED_NAME_ORIGINS = {
    "ida_named_or_other": 4052,
    "target_jni_export": 7,
    "target_named_export": 808,
    "target_only_descriptive": 419,
    "translated_v18_alias": 6421,
}
EXPECTED_DYNAMIC_SUMMARY = {
    ...
    "name_match_counts": {
        "item_name_match": 1696,
        "item_name_mismatch": 5074,
        "value_name_match": 1696,
        "value_name_mismatch": 5074,
    },
    "named_dynamic_symbol_count": 6770,
    "status_counts": {
        "exact_retained_dynamic_name": 1696,
        "linker_boundary_alias_mismatch": 7,
        "other_retained_target_name": 121,
        "source_backed_v18_alias": 4774,
...
def main() -> None:
    ...
    require(parent["database"]["sha256"] == EXPECTED_PARENT_DATABASE_SHA256, "parent database hash is not v338")
    require(anchors.get("artifact") == EXPECTED_ANCHOR_ARTIFACT, "unexpected geometry anchor artifact")
    require(anchors.get("network_contacted") is False, "geometry anchors contacted the network")
    require(anchors.get("summary") == EXPECTED_ANCHOR_SUMMARY, "geometry anchor summary changed")
    require([row["proposed_name"] for row in anchors["anchors"]] == EXPECTED_ALIASES, "geometry alias order changed")
    require([row["spectron_ea"] for row in anchors["anchors"]] == EXPECTED_TARGETS, "geometry target order changed")
    require(
        ...
        "geometry alias application did not pass",
    )
    require(
        ...
        "geometry alias reopen verification did not pass",
    )
    require(
    ...
    require(
        ...
        "v339 dynamic boundary audit changed",
    )
    require(
        ...
        "v339 dynamic symbol coverage changed",
    )
    require(
        ...
        "v339 semantic map changed",
    )
    require(feature_export.get("function_count") == 11707, "v339 feature export count changed")
    require(args.database.is_file(), "database path is not a regular file")
    database_sha256 = sha256_path(args.database)
    require(database_sha256 == EXPECTED_DATABASE_SHA256, "v339 database hash changed")
    ...
    result["inputs"] = {
        **parent.get("inputs", {}),
        "v339_geometry_anchor_artifact": str(args.anchor_artifact),
        "v339_geometry_anchor_artifact_sha256": sha256_path(args.anchor_artifact),
        "v339_geometry_application_report": str(args.application_report),
        "v339_geometry_application_report_sha256": sha256_path(args.application_report),
        "v339_geometry_verification_report": str(args.verification_report),
        "v339_geometry_verification_report_sha256": sha256_path(args.verification_report),
        "v339_name_audit": str(args.name_audit),
        "v339_name_audit_sha256": sha256_path(args.name_audit),
        "v339_boundary_audit": str(args.boundary_audit),
        "v339_boundary_audit_sha256": sha256_path(args.boundary_audit),
        "v339_dynamic_symbol_coverage": str(args.dynamic_symbol_coverage),
        "v339_dynamic_symbol_coverage_sha256": sha256_path(args.dynamic_symbol_coverage),
        "v339_semantic_map": str(args.semantic_map),
        "v339_semantic_map_sha256": sha256_path(args.semantic_map),
        "v339_feature_export": str(args.feature_export),
        "v339_feature_export_sha256": sha256_path(args.feature_export),
    }
    result["geometry_translation_v339"] = {
    ...
    result["name_coverage_audit_v339"] = {
    ...
    result["dynamic_function_boundary_audit_v339"] = {
    ...
    result["dynamic_symbol_coverage_audit_v339"] = {
    ...
    result["semantic_function_translation_v339"] = {
    ...
    result["interpretation"].append(
        "The v339 pass adds four reviewed aliases for the residual TFloatRectangle, TDoubleRectangle, and TRegion geometry methods."
    )
    result["interpretation"].append(
        "All four rows are exact normalized ARM64 matches with direct Hex-Rays pseudocode on both builds."
    )
