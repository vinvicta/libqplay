...
def main():
    ...
    coverage_v321_origins = spectron_name_coverage_v321["name_origins"]
    check(
        "Spectron v321 source boundary application",
        original_dynamic_function_application_v321["artifact"],
        "original_dynamic_function_application",
    )
    check(
        "Spectron v321 source boundary network",
        original_dynamic_function_application_v321["network_contacted"],
        False,
    )
    check(
        "Spectron v321 source boundary rows",
        original_dynamic_function_application_v321["row_count"],
        11,
    )
    check(
        "Spectron v321 source boundary materialized",
        original_dynamic_function_application_v321["materialized_count"],
        11,
    )
    check(
        "Spectron v321 source boundary renamed",
        original_dynamic_function_application_v321["renamed_count"],
        11,
    )
    check(
        "Spectron v321 source boundary failures",
        original_dynamic_function_application_v321["failure_count"],
        0,
    )
    check(
        "Spectron v321 source boundary saved",
        original_dynamic_function_application_v321["saved"],
        True,
    )
    check(
        "Spectron v321 GUI anchor artifact",
        spectron_gui_missing_function_anchors_v321["artifact"],
        "spectron_gui_missing_function_manual_translation_anchors_20260828",
    )
    check(
        "Spectron v321 GUI anchor network",
        spectron_gui_missing_function_anchors_v321["network_contacted"],
        False,
    )
    check(
        "Spectron v321 GUI anchor summary",
        spectron_gui_missing_function_anchors_v321["summary"],
        {
            "anchor_count": 11,
            "full_metric_exact_count": 0,
            "high_confidence_count": 10,
            "medium_confidence_count": 1,
            "metric_difference_count": 11,
            "normalized_shape_exact_count": 2,
        },
    )
    check(
        "Spectron v321 GUI application artifact",
        spectron_gui_missing_function_application_v321["artifact"],
        "spectron_manual_anchor_application",
    )
    check(
        "Spectron v321 GUI application counts",
        {
            "anchor_count": spectron_gui_missing_function_application_v321["anchor_count"],
            "resolved_count": spectron_gui_missing_function_application_v321["resolved_count"],
            "renamed_count": spectron_gui_missing_function_application_v321["renamed_count"],
            "comments_added": spectron_gui_missing_function_application_v321["comments_added"],
            "failure_count": spectron_gui_missing_function_application_v321["failure_count"],
            "saved": spectron_gui_missing_function_application_v321["saved"],
            "verified": spectron_gui_missing_function_application_v321["verified"],
            "verified_name_count": spectron_gui_missing_function_application_v321["verified_name_count"],
        },
        {
            "anchor_count": 11,
            "resolved_count": 11,
            ...
            "saved": True,
            "verified": True,
            "verified_name_count": 11,
        },
    )
    check(
        "Spectron v321 GUI reopen verification",
        {
            "anchor_count": spectron_gui_missing_function_verification_v321["anchor_count"],
            "failure_count": spectron_gui_missing_function_verification_v321["failure_count"],
            "function_count": spectron_gui_missing_function_verification_v321["function_count"],
            "verified": spectron_gui_missing_function_verification_v321["verified"],
            "verified_name_count": spectron_gui_missing_function_verification_v321["verified_name_count"],
        },
        {
            "anchor_count": 11,
            "failure_count": 0,
    ...
    check(
        "Spectron v321 semantic translation network",
        spectron_semantic_translation_v320["network_contacted"],
        False,
    )
    check(
        "Spectron v321 semantic translation summary",
        spectron_semantic_translation_v320["summary"],
        {
    ...
    check(
        "Spectron v321 name audit input hash",
        spectron_name_coverage_v321["input_sha256"],
        "f57f7da48bcddf3738f15502328b36032313ad760eea04c5cc19ef82b4232219",
    )
    check(
        "Spectron v321 name audit function count",
        spectron_name_coverage_v321["function_count"],
        11707,
    )
    check(
        "Spectron v321 name audit default count",
        spectron_name_coverage_v321["default_name_count"],
        0,
    )
    check(
        "Spectron v321 name audit origin counts",
        coverage_v321_origins,
        {
            "ida_named_or_other": 4053,
            "target_jni_export": 7,
    ...
    check(
        "Spectron v321 dynamic boundary artifact",
        spectron_dynamic_boundaries_v321["artifact"],
        "spectron_dynamic_symbol_boundary_audit",
    )
    check(
        "Spectron v321 dynamic boundary network",
        spectron_dynamic_boundaries_v321["network_contacted"],
        False,
    )
    check(
        "Spectron v321 dynamic boundary input hash",
        spectron_dynamic_boundaries_v321["input_sha256"],
        "f57f7da48bcddf3738f15502328b36032313ad760eea04c5cc19ef82b4232219",
    )
    check(
        "Spectron v321 dynamic boundary counts",
        {
            "defined_function_symbol_count": spectron_dynamic_boundaries_v321["defined_function_symbol_count"],
            "ida_exact_start_count": spectron_dynamic_boundaries_v321["ida_exact_start_count"],
            "ida_missing_exact_start_count": spectron_dynamic_boundaries_v321["ida_missing_exact_start_count"],
            "row_count": len(spectron_dynamic_boundaries_v321["rows"]),
        },
        {
    ...
    dynamic_symbol_coverage_v321_summary = spectron_dynamic_symbol_coverage_v321["summary"]
    check(
        "Spectron v321 dynamic symbol coverage artifact",
        spectron_dynamic_symbol_coverage_v321["artifact"],
        "spectron_dynamic_symbol_coverage_audit_20260828",
    )
    check(
        "Spectron v321 dynamic symbol coverage network",
        spectron_dynamic_symbol_coverage_v321["network_contacted"],
        False,
    )
    check(
        "Spectron v321 dynamic symbol coverage input hash",
        spectron_dynamic_symbol_coverage_v321["input_sha256"],
        "f57f7da48bcddf3738f15502328b36032313ad760eea04c5cc19ef82b4232219",
    )
    check(
        "Spectron v321 dynamic symbol coverage summary",
        dynamic_symbol_coverage_v321_summary,
        {
    ...
    check(
        "Spectron v321 checkpoint artifact",
        spectron_checkpoint_v321["artifact"],
        "spectron_translation_checkpoint_20260828_v321",
    )
    check(
        "Spectron v321 checkpoint parent",
        spectron_checkpoint_v321["parent_checkpoint"]["artifact"],
        "spectron_translation_checkpoint_20260828_v320",
    )
    check(
        "Spectron v321 checkpoint database hash",
        spectron_checkpoint_v321["database"]["sha256"],
        "b7d17b9a5dbc34922cc40fe030cb539d69dcf89fe8a5f64bae83e962309263ab",
    )
    check(
        "Spectron v321 checkpoint database close-reopen",
        spectron_checkpoint_v321["database"]["close_reopen_verified"],
        True,
    )
    check(
        "Spectron v321 checkpoint function count",
        spectron_checkpoint_v321["database"]["function_count"],
        11707,
    )
    check(
        "Spectron v321 checkpoint default names",
        spectron_checkpoint_v321["database"]["default_name_count"],
        0,
    )
    check(
        "Spectron v321 checkpoint dynamic boundary repair",
        {
            "materialized_count": spectron_checkpoint_v321["dynamic_function_boundary_repair"]["materialized_count"],
            "ida_exact_start_count": spectron_checkpoint_v321["dynamic_function_boundary_repair"]["ida_exact_start_count"],
            "ida_missing_exact_start_count": spectron_checkpoint_v321["dynamic_function_boundary_repair"]["ida_missing_exact_start_count"],
            "reopen_failure_count": spectron_checkpoint_v321["dynamic_function_boundary_repair"]["reopen_failure_count"],
        },
        {
            "materialized_count": 12,
            "ida_exact_start_count": 5782,
            "ida_missing_exact_start_count": 0,
            "reopen_failure_count": 0,
        },
    )
    check(
        "Spectron v321 checkpoint GUI translation",
        {
            "anchor_count": spectron_checkpoint_v321["gui_missing_function_translation_v321"]["anchor_count"],
            "high_confidence_count": spectron_checkpoint_v321["gui_missing_function_translation_v321"]["high_confidence_count"],
            "medium_confidence_count": spectron_checkpoint_v321["gui_missing_function_translation_v321"]["medium_confidence_count"],
            "source_materialized_count": spectron_checkpoint_v321["gui_missing_function_translation_v321"]["source_materialized_count"],
            "reopen_verified": spectron_checkpoint_v321["gui_missing_function_translation_v321"]["reopen_verified"],
        },
        {
            "anchor_count": 11,
            "high_confidence_count": 10,
            "medium_confidence_count": 1,
            "source_materialized_count": 11,
            "reopen_verified": True,
        },
    )
    check(
        "Spectron v322 TGraalVar anchor artifact",
        spectron_tgraalvar_runtime_gap_anchors_v322["artifact"],
        "spectron_tgraalvar_runtime_gap_manual_translation_anchors_20260829",
    )
    check(
        "Spectron v322 TGraalVar anchor network",
        spectron_tgraalvar_runtime_gap_anchors_v322["network_contacted"],
        False,
    )
    check(
        "Spectron v322 TGraalVar anchor summary",
        spectron_tgraalvar_runtime_gap_anchors_v322["summary"],
        {
            "anchor_count": 12,
    ...
    check(
        "Spectron v322 TGraalVar source aliases",
        [row["proposed_name"] for row in spectron_tgraalvar_runtime_gap_anchors_v322["anchors"]],
        [
            "v18_TGraalVar_receiveEvent_script_event",
            "v18_TGraalVar_getVarNames_bool_bool_bool",
            "v18_parseDynamicFunctionParameters_char_const_std_va_list",
            "v18_TGraalVar_executeStringFunctionF_TString_const_char_const",
            "v18_TGraalVar_saveString_TString_const_uint",
            "v18_TGraalVar_saveLines_TString_const_uint",
            "v18_TGraalVar_loadString_TString_const",
            "v18_TGraalVar_setVarValueAsFloat_TString_const_double",
            "v18_TGraalVar_getVarValue_TString_const",
            "v18_TGraalVar_setArrayCellObject_int_TGraalVar",
            "v18_TGraalVar_getVarValueAsFloat_TString_const",
            "v18_TGraalVar_updateArrayString_void",
        ],
    )
    check(
        "Spectron v322 TGraalVar target addresses",
        [row["spectron_ea"] for row in spectron_tgraalvar_runtime_gap_anchors_v322["anchors"]],
        [
            "0x2136c4",
            "0x214520",
            "0x214a78",
    ...
    check(
        "Spectron v322 TGraalVar application artifact",
        spectron_tgraalvar_runtime_gap_application_v322["artifact"],
        "spectron_manual_anchor_application",
    )
    check(
        "Spectron v322 TGraalVar application counts",
        {
            "anchor_count": spectron_tgraalvar_runtime_gap_application_v322["anchor_count"],
            "resolved_count": spectron_tgraalvar_runtime_gap_application_v322["resolved_count"],
            "renamed_count": spectron_tgraalvar_runtime_gap_application_v322["renamed_count"],
            "comments_added": spectron_tgraalvar_runtime_gap_application_v322["comments_added"],
            "failure_count": spectron_tgraalvar_runtime_gap_application_v322["failure_count"],
            "saved": spectron_tgraalvar_runtime_gap_application_v322["saved"],
            "verified": spectron_tgraalvar_runtime_gap_application_v322["verified"],
            "verified_name_count": spectron_tgraalvar_runtime_gap_application_v322["verified_name_count"],
        },
        {
            "anchor_count": 12,
            "resolved_count": 12,
            ...
            "saved": True,
            "verified": True,
            "verified_name_count": 12,
        },
    )
    check(
        "Spectron v322 TGraalVar reopen verification",
        {
            "anchor_count": spectron_tgraalvar_runtime_gap_verification_v322["anchor_count"],
            "failure_count": spectron_tgraalvar_runtime_gap_verification_v322["failure_count"],
            "function_count": spectron_tgraalvar_runtime_gap_verification_v322["function_count"],
            "verified": spectron_tgraalvar_runtime_gap_verification_v322["verified"],
            "verified_name_count": spectron_tgraalvar_runtime_gap_verification_v322["verified_name_count"],
        },
        {
            "anchor_count": 12,
            "failure_count": 0,
    ...
    coverage_v322_origins = spectron_name_coverage_v322["name_origins"]
    check(
        "Spectron v322 name audit input hash",
        spectron_name_coverage_v322["input_sha256"],
        "f57f7da48bcddf3738f15502328b36032313ad760eea04c5cc19ef82b4232219",
    )
    check(
        "Spectron v322 name audit function count",
        spectron_name_coverage_v322["function_count"],
        11707,
    )
    check(
        "Spectron v322 name audit default count",
        spectron_name_coverage_v322["default_name_count"],
        0,
    )
    check(
        "Spectron v322 name audit origin counts",
        coverage_v322_origins,
        {
            "ida_named_or_other": 4053,
            "target_jni_export": 7,
    ...
    check(
        "Spectron v322 dynamic boundary artifact",
        spectron_dynamic_boundaries_v322["artifact"],
        "spectron_dynamic_symbol_boundary_audit",
    )
    check(
        "Spectron v322 dynamic boundary network",
        spectron_dynamic_boundaries_v322["network_contacted"],
        False,
    )
    check(
        "Spectron v322 dynamic boundary input hash",
        spectron_dynamic_boundaries_v322["input_sha256"],
        "f57f7da48bcddf3738f15502328b36032313ad760eea04c5cc19ef82b4232219",
    )
    check(
        "Spectron v322 dynamic boundary counts",
        {
            "defined_function_symbol_count": spectron_dynamic_boundaries_v322["defined_function_symbol_count"],
            "ida_exact_start_count": spectron_dynamic_boundaries_v322["ida_exact_start_count"],
            "ida_missing_exact_start_count": spectron_dynamic_boundaries_v322["ida_missing_exact_start_count"],
            "row_count": len(spectron_dynamic_boundaries_v322["rows"]),
        },
        {
            "defined_function_symbol_count": 5782,
            "ida_exact_start_count": 5782,
    ...
    dynamic_symbol_coverage_v322_summary = spectron_dynamic_symbol_coverage_v322["summary"]
    check(
        "Spectron v322 dynamic symbol coverage artifact",
        spectron_dynamic_symbol_coverage_v322["artifact"],
        "spectron_dynamic_symbol_coverage_audit_20260828",
    )
    check(
        "Spectron v322 dynamic symbol coverage network",
        spectron_dynamic_symbol_coverage_v322["network_contacted"],
        False,
    )
    check(
        "Spectron v322 dynamic symbol coverage input hash",
        spectron_dynamic_symbol_coverage_v322["input_sha256"],
        "f57f7da48bcddf3738f15502328b36032313ad760eea04c5cc19ef82b4232219",
    )
    check(
        "Spectron v322 dynamic symbol coverage summary",
        dynamic_symbol_coverage_v322_summary,
        {
            "defined_named_symbol_count": 6600,
            "location_counts": {
                "ida_data_item": 482,
    ...
    check(
        "Spectron v322 checkpoint artifact",
        spectron_checkpoint_v322["artifact"],
        "spectron_translation_checkpoint_20260829_v322",
    )
    check(
        "Spectron v322 checkpoint parent",
        spectron_checkpoint_v322["parent_checkpoint"]["artifact"],
        "spectron_translation_checkpoint_20260828_v321",
    )
    check(
        "Spectron v322 checkpoint database hash",
        spectron_checkpoint_v322["database"]["sha256"],
        "af0f2361668f7cd375b33242a0b21591a53446c332c0e77c8a4e51e3c6bdf1ad",
    )
    check(
        "Spectron v322 checkpoint database close-reopen",
        spectron_checkpoint_v322["database"]["close_reopen_verified"],
        True,
    )
    check(
        "Spectron v322 checkpoint function count",
        spectron_checkpoint_v322["database"]["function_count"],
        11707,
    )
    check(
        "Spectron v322 checkpoint default names",
        spectron_checkpoint_v322["database"]["default_name_count"],
        0,
    )
    check(
        "Spectron v322 checkpoint TGraalVar translation",
        {
            "anchor_count": spectron_checkpoint_v322["tgraalvar_runtime_gap_translation_v322"]["anchor_count"],
            "high_confidence_count": spectron_checkpoint_v322["tgraalvar_runtime_gap_translation_v322"]["high_confidence_count"],
            "layout_change_anchor_count": spectron_checkpoint_v322["tgraalvar_runtime_gap_translation_v322"]["layout_change_anchor_count"],
            "reopen_verified": spectron_checkpoint_v322["tgraalvar_runtime_gap_translation_v322"]["reopen_verified"],
        },
        {
            "anchor_count": 12,
            "high_confidence_count": 12,
    ...
    check(
        "Spectron v323 TGraalVar continuation anchor artifact",
        spectron_tgraalvar_runtime_continuation_anchors_v323["artifact"],
        "spectron_tgraalvar_runtime_continuation_manual_translation_anchors_20260829",
    )
    check(
        "Spectron v323 TGraalVar continuation anchor network",
        spectron_tgraalvar_runtime_continuation_anchors_v323["network_contacted"],
        False,
    )
    check(
        "Spectron v323 TGraalVar continuation anchor summary",
        spectron_tgraalvar_runtime_continuation_anchors_v323["summary"],
        {
            "anchor_count": 23,
    ...
    check(
        "Spectron v323 TGraalVar continuation source aliases",
        [
            row["proposed_name"]
            for row in spectron_tgraalvar_runtime_continuation_anchors_v323["anchors"]
        ],
        [
            "v18_TGraalVar_runScript_void",
            "v18_TGraalVar_leaveClass_TString_const",
            "v18_TGraalVar_cancelEvents_TString_const",
            "v18_TGraalVar_setScript_TString_const",
            "v18_TGraalVar_setScript_TScript",
            "v18_TGraalVar_freeScript_void",
            "v18_TGraalVar_hasFunction_TString_const",
            "v18_TGraalVar_sortList_bool",
            "v18_TGraalVar_sortListByValue_TString_const_TString_const_bool",
            "v18_TGraalVar_listSubVars_TStringList_TString_const",
            "v18_TGraalVar_saveVarsToArray_void",
            "v18_TGraalVar_writeFloatOrString_TString_const",
            "v18_TGraalVar_setSubVar_TString_const",
            "v18_TGraalVar_setVarValue_TString_const_TString_const",
            "v18_TGraalVar_getArrayMember_TString_const",
            "v18_TGraalVar_copyFrom_TGraalVar",
            "v18_TGraalVar_getFunctions_void",
            "v18_TGraalVar_writeStringList_TStringList",
            "v18_TGraalVar_insertArrayCellFloat_int_double",
            "v18_TGraalVar_insertArrayCellString_int_TString_const",
            "v18_TGraalVar_insertArrayCellObject_int_TGraalVar",
            "v18_TGraalVar_initStaticScriptVars_void",
            "v18_TGraalVar_writeString_TString_const",
        ],
    )
    check(
        "Spectron v323 TGraalVar continuation target addresses",
        [
            row["spectron_ea"]
            for row in spectron_tgraalvar_runtime_continuation_anchors_v323["anchors"]
        ],
    ...
    check(
        "Spectron v323 TGraalVar continuation application artifact",
        spectron_tgraalvar_runtime_continuation_application_v323["artifact"],
        "spectron_manual_anchor_application",
    )
    check(
        "Spectron v323 TGraalVar continuation application counts",
        {
            "anchor_count": spectron_tgraalvar_runtime_continuation_application_v323["anchor_count"],
            "resolved_count": spectron_tgraalvar_runtime_continuation_application_v323["resolved_count"],
            "renamed_count": spectron_tgraalvar_runtime_continuation_application_v323["renamed_count"],
            "comments_added": spectron_tgraalvar_runtime_continuation_application_v323["comments_added"],
            "failure_count": spectron_tgraalvar_runtime_continuation_application_v323["failure_count"],
            "saved": spectron_tgraalvar_runtime_continuation_application_v323["saved"],
            "verified": spectron_tgraalvar_runtime_continuation_application_v323["verified"],
            "verified_name_count": spectron_tgraalvar_runtime_continuation_application_v323["verified_name_count"],
        },
        {
            "anchor_count": 23,
            "resolved_count": 23,
            ...
            "saved": True,
            "verified": True,
            "verified_name_count": 23,
        },
    )
    check(
        "Spectron v323 TGraalVar continuation reopen verification",
        {
            "anchor_count": spectron_tgraalvar_runtime_continuation_verification_v323["anchor_count"],
            "failure_count": spectron_tgraalvar_runtime_continuation_verification_v323["failure_count"],
            "function_count": spectron_tgraalvar_runtime_continuation_verification_v323["function_count"],
            "verified": spectron_tgraalvar_runtime_continuation_verification_v323["verified"],
            "verified_name_count": spectron_tgraalvar_runtime_continuation_verification_v323["verified_name_count"],
        },
        {
            "anchor_count": 23,
            "failure_count": 0,
    ...
    coverage_v323_origins = spectron_name_coverage_v323["name_origins"]
    check(
        "Spectron v323 name audit input hash",
        spectron_name_coverage_v323["input_sha256"],
        "f57f7da48bcddf3738f15502328b36032313ad760eea04c5cc19ef82b4232219",
    )
    check(
        "Spectron v323 name audit function count",
        spectron_name_coverage_v323["function_count"],
        11707,
    )
    check(
        "Spectron v323 name audit default count",
        spectron_name_coverage_v323["default_name_count"],
        0,
    )
    check(
        "Spectron v323 name audit origin counts",
        coverage_v323_origins,
        {
            "ida_named_or_other": 4053,
            "target_jni_export": 7,
    ...
    check(
        "Spectron v323 dynamic boundary artifact",
        spectron_dynamic_boundaries_v323["artifact"],
        "spectron_dynamic_symbol_boundary_audit",
    )
    check(
        "Spectron v323 dynamic boundary network",
        spectron_dynamic_boundaries_v323["network_contacted"],
        False,
    )
    check(
        "Spectron v323 dynamic boundary input hash",
        spectron_dynamic_boundaries_v323["input_sha256"],
        "f57f7da48bcddf3738f15502328b36032313ad760eea04c5cc19ef82b4232219",
    )
    check(
        "Spectron v323 dynamic boundary counts",
        {
            "defined_function_symbol_count": spectron_dynamic_boundaries_v323["defined_function_symbol_count"],
            "ida_exact_start_count": spectron_dynamic_boundaries_v323["ida_exact_start_count"],
            "ida_missing_exact_start_count": spectron_dynamic_boundaries_v323["ida_missing_exact_start_count"],
            "row_count": len(spectron_dynamic_boundaries_v323["rows"]),
        },
        {
            "defined_function_symbol_count": 5782,
            "ida_exact_start_count": 5782,
    ...
    dynamic_symbol_coverage_v323_summary = spectron_dynamic_symbol_coverage_v323["summary"]
    check(
        "Spectron v323 dynamic symbol coverage artifact",
        spectron_dynamic_symbol_coverage_v323["artifact"],
        "spectron_dynamic_symbol_coverage_audit_20260828",
    )
    check(
        "Spectron v323 dynamic symbol coverage network",
        spectron_dynamic_symbol_coverage_v323["network_contacted"],
        False,
    )
    check(
        "Spectron v323 dynamic symbol coverage input hash",
        spectron_dynamic_symbol_coverage_v323["input_sha256"],
        "f57f7da48bcddf3738f15502328b36032313ad760eea04c5cc19ef82b4232219",
    )
    check(
        "Spectron v323 dynamic symbol coverage summary",
        dynamic_symbol_coverage_v323_summary,
        {
            "defined_named_symbol_count": 6600,
            "location_counts": {
                "ida_data_item": 482,
    ...
    check(
        "Spectron v323 checkpoint artifact",
        spectron_checkpoint_v323["artifact"],
        "spectron_translation_checkpoint_20260829_v323",
    )
    check(
        "Spectron v323 checkpoint parent",
        spectron_checkpoint_v323["parent_checkpoint"]["artifact"],
        "spectron_translation_checkpoint_20260829_v322",
    )
    check(
        "Spectron v323 checkpoint database hash",
        spectron_checkpoint_v323["database"]["sha256"],
        "588e39f73c0946aea4ed45265820c9d95a73689339c365840b308170d36d0b4d",
    )
    check(
        "Spectron v323 checkpoint database close-reopen",
        spectron_checkpoint_v323["database"]["close_reopen_verified"],
        True,
    )
    check(
        "Spectron v323 checkpoint function count",
        spectron_checkpoint_v323["database"]["function_count"],
        11707,
    )
    check(
        "Spectron v323 checkpoint default names",
        spectron_checkpoint_v323["database"]["default_name_count"],
        0,
    )
    check(
        "Spectron v323 checkpoint TGraalVar continuation",
        {
            "anchor_count": spectron_checkpoint_v323["tgraalvar_runtime_continuation_translation_v323"]["anchor_count"],
            "high_confidence_count": spectron_checkpoint_v323["tgraalvar_runtime_continuation_translation_v323"]["high_confidence_count"],
            "layout_change_anchor_count": spectron_checkpoint_v323["tgraalvar_runtime_continuation_translation_v323"]["layout_change_anchor_count"],
            "reopen_verified": spectron_checkpoint_v323["tgraalvar_runtime_continuation_translation_v323"]["reopen_verified"],
        },
        {
            "anchor_count": 23,
            "high_confidence_count": 23,
    ...
    check(
        "Spectron v324 TScript runtime anchor artifact",
        spectron_tscript_runtime_anchors_v324["artifact"],
        "spectron_tscript_runtime_manual_translation_anchors_20260829",
    )
    check(
        "Spectron v324 TScript runtime anchor network",
        spectron_tscript_runtime_anchors_v324["network_contacted"],
        False,
    )
    check(
        "Spectron v324 TScript runtime anchor summary",
        spectron_tscript_runtime_anchors_v324["summary"],
        {
            "anchor_count": 24,
    ...
    check(
        "Spectron v324 TScript runtime source aliases",
        [
            row["proposed_name"]
            for row in spectron_tscript_runtime_anchors_v324["anchors"]
        ],
        [
            "v18_TScriptFunction_TScriptFunction_TScript_TString_const_int_int",
            "v18_TScriptFunction_addToFreeCallStackEntries_TCallStackEntry",
            "v18_TScriptFunction_clearCallStackEntries_void",
            "v18_TScriptFunction_TScriptFunction",
            "v18_TScriptFunction_TScriptFunction__2",
            "v18_TScript_TScript_TString_const",
            "v18_TScript_addCatchedEvent_TString_const_TString_const_int",
            "v18_TScript_getFunction_TString_const",
            "v18_TScript_getEventFunctions_TList_TString_const",
            "v18_TScript_installSelfEventCatchers_TGraalVar",
            "v18_TScript_installEventCatchers_TGraalVar",
            "v18_TScript_addFunctionProfilerTime_TString_const_double_double",
            "v18_TScript_optimizeByteCode_void",
            "v18_TScript_loadScriptEncrypted_int_TString_const_uint",
            "v18_TScript_checkRequestScript_int_TString_const_uint",
            "v18_TScript_initStaticVars_void",
            "v18_TScript_initStaticScriptVars_void",
            "v18_TScriptEnvironment_getPropertyList_TString_const",
            "v18_TScriptEnvironment_makeTempVar_void",
            "v18_TScriptEnvironment_makeArrayVar_bool",
            "v18_TScriptEnvironment_makeVarFromStringList_TStringList_const_bool",
            "v18_TScriptEnvironment_makeVarFromCommaText_TString_const_bool",
            "v18_TScriptEnvironment_makeStringListFromVar_TGraalVar",
            "v18_TScriptEnvironment_initStaticVars_void",
        ],
    )
    check(
        "Spectron v324 TScript runtime target addresses",
        [
            row["spectron_ea"]
            for row in spectron_tscript_runtime_anchors_v324["anchors"]
        ],
    ...
    check(
        "Spectron v324 TScript runtime application artifact",
        spectron_tscript_runtime_application_v324["artifact"],
        "spectron_manual_anchor_application",
    )
    check(
        "Spectron v324 TScript runtime application counts",
        {
            "anchor_count": spectron_tscript_runtime_application_v324["anchor_count"],
            "resolved_count": spectron_tscript_runtime_application_v324["resolved_count"],
            "renamed_count": spectron_tscript_runtime_application_v324["renamed_count"],
            "comments_added": spectron_tscript_runtime_application_v324["comments_added"],
            "failure_count": spectron_tscript_runtime_application_v324["failure_count"],
            "saved": spectron_tscript_runtime_application_v324["saved"],
            "verified": spectron_tscript_runtime_application_v324["verified"],
            "verified_name_count": spectron_tscript_runtime_application_v324["verified_name_count"],
        },
        {
            "anchor_count": 24,
            "resolved_count": 24,
            ...
            "saved": True,
            "verified": True,
            "verified_name_count": 24,
        },
    )
    check(
        "Spectron v324 TScript runtime reopen verification",
        {
            "anchor_count": spectron_tscript_runtime_verification_v324["anchor_count"],
            "failure_count": spectron_tscript_runtime_verification_v324["failure_count"],
            "function_count": spectron_tscript_runtime_verification_v324["function_count"],
            "verified": spectron_tscript_runtime_verification_v324["verified"],
            "verified_name_count": spectron_tscript_runtime_verification_v324["verified_name_count"],
        },
        {
            "anchor_count": 24,
            "failure_count": 0,
    ...
    coverage_v324_origins = spectron_name_coverage_v324["name_origins"]
    check(
        "Spectron v324 name audit input hash",
        spectron_name_coverage_v324["input_sha256"],
        "f57f7da48bcddf3738f15502328b36032313ad760eea04c5cc19ef82b4232219",
    )
    check(
        "Spectron v324 name audit function count",
        spectron_name_coverage_v324["function_count"],
        11707,
    )
    check(
        "Spectron v324 name audit default count",
        spectron_name_coverage_v324["default_name_count"],
        0,
    )
    check(
        "Spectron v324 name audit origin counts",
        coverage_v324_origins,
        {
            "ida_named_or_other": 4053,
            "target_jni_export": 7,
    ...
    check(
        "Spectron v324 dynamic boundary artifact",
        spectron_dynamic_boundaries_v324["artifact"],
        "spectron_dynamic_symbol_boundary_audit",
    )
    check(
        "Spectron v324 dynamic boundary network",
        spectron_dynamic_boundaries_v324["network_contacted"],
        False,
    )
    check(
        "Spectron v324 dynamic boundary input hash",
        spectron_dynamic_boundaries_v324["input_sha256"],
        "f57f7da48bcddf3738f15502328b36032313ad760eea04c5cc19ef82b4232219",
    )
    check(
        "Spectron v324 dynamic boundary counts",
        {
            "defined_function_symbol_count": spectron_dynamic_boundaries_v324["defined_function_symbol_count"],
            "ida_exact_start_count": spectron_dynamic_boundaries_v324["ida_exact_start_count"],
            "ida_missing_exact_start_count": spectron_dynamic_boundaries_v324["ida_missing_exact_start_count"],
            "row_count": len(spectron_dynamic_boundaries_v324["rows"]),
        },
        {
            "defined_function_symbol_count": 5782,
            "ida_exact_start_count": 5782,
    ...
    dynamic_symbol_coverage_v324_summary = spectron_dynamic_symbol_coverage_v324["summary"]
    check(
        "Spectron v324 dynamic symbol coverage artifact",
        spectron_dynamic_symbol_coverage_v324["artifact"],
        "spectron_dynamic_symbol_coverage_audit_20260828",
    )
    check(
        "Spectron v324 dynamic symbol coverage network",
        spectron_dynamic_symbol_coverage_v324["network_contacted"],
        False,
    )
    check(
        "Spectron v324 dynamic symbol coverage input hash",
        spectron_dynamic_symbol_coverage_v324["input_sha256"],
        "f57f7da48bcddf3738f15502328b36032313ad760eea04c5cc19ef82b4232219",
    )
    check(
        "Spectron v324 dynamic symbol coverage summary",
        dynamic_symbol_coverage_v324_summary,
        {
            "defined_named_symbol_count": 6600,
            "location_counts": {
                "ida_data_item": 482,
    ...
    check(
        "Spectron v324 checkpoint artifact",
        spectron_checkpoint_v324["artifact"],
        "spectron_translation_checkpoint_20260829_v324",
    )
    check(
        "Spectron v324 checkpoint parent",
        spectron_checkpoint_v324["parent_checkpoint"]["artifact"],
        "spectron_translation_checkpoint_20260829_v323",
    )
    check(
        "Spectron v324 checkpoint database hash",
        spectron_checkpoint_v324["database"]["sha256"],
        "975367646c22c2f21d1c7ffc8380e0b48a6c259864a1f8b192e043c3e0992e06",
    )
    check(
        "Spectron v324 checkpoint database close-reopen",
        spectron_checkpoint_v324["database"]["close_reopen_verified"],
        True,
    )
    check(
        "Spectron v324 checkpoint function count",
        spectron_checkpoint_v324["database"]["function_count"],
        11707,
    )
    check(
        "Spectron v324 checkpoint default names",
        spectron_checkpoint_v324["database"]["default_name_count"],
        0,
    )
    check(
        "Spectron v324 checkpoint TScript runtime translation",
        {
            "anchor_count": spectron_checkpoint_v324["tscript_runtime_translation_v324"]["anchor_count"],
            "high_confidence_count": spectron_checkpoint_v324["tscript_runtime_translation_v324"]["high_confidence_count"],
            "layout_change_anchor_count": spectron_checkpoint_v324["tscript_runtime_translation_v324"]["layout_change_anchor_count"],
            "reopen_verified": spectron_checkpoint_v324["tscript_runtime_translation_v324"]["reopen_verified"],
        },
        {
            "anchor_count": 24,
            "high_confidence_count": 24,
    ...
    check(
        "Spectron v325 TScript destructor anchor artifact",
        spectron_tscript_destructor_anchors_v325["artifact"],
        "spectron_tscript_destructor_manual_translation_anchors_20260829",
    )
    check(
        "Spectron v325 TScript destructor anchor network",
        spectron_tscript_destructor_anchors_v325["network_contacted"],
        False,
    )
    check(
        "Spectron v325 TScript destructor anchor summary",
        spectron_tscript_destructor_anchors_v325["summary"],
        {
            "anchor_count": 8,
            "exact_metric_anchor_count": 3,
    ...
    check(
        "Spectron v325 TScript destructor source aliases",
        [
            row["proposed_name"]
            for row in spectron_tscript_destructor_anchors_v325["anchors"]
        ],
        [
            "v18_TScript_getLogName_void",
            "v18_TScript_TScript__2",
            "v18_TScriptFunctionProperties_TScriptFunctionProperties",
            "v18_non_virtual_thunk_to_TScriptFunctionProperties_TScriptFunctionProperties",
            "v18_TScriptFunctionProperties_TScriptFunctionProperties__2",
            "v18_non_virtual_thunk_to_TScriptFunctionProperties_TScriptFunctionProperties__2",
            "v18_TFunctionProfile_TFunctionProfile",
            "v18_TFunctionProfile_TFunctionProfile__2",
        ],
    )
    check(
        "Spectron v325 TScript destructor target addresses",
        [
            row["spectron_ea"]
            for row in spectron_tscript_destructor_anchors_v325["anchors"]
        ],
    ...
    check(
        "Spectron v325 TScript destructor application artifact",
        spectron_tscript_destructor_application_v325["artifact"],
        "spectron_manual_anchor_application",
    )
    check(
        "Spectron v325 TScript destructor application counts",
        {
            "anchor_count": spectron_tscript_destructor_application_v325["anchor_count"],
            "resolved_count": spectron_tscript_destructor_application_v325["resolved_count"],
            "renamed_count": spectron_tscript_destructor_application_v325["renamed_count"],
            "comments_added": spectron_tscript_destructor_application_v325["comments_added"],
            "failure_count": spectron_tscript_destructor_application_v325["failure_count"],
            "saved": spectron_tscript_destructor_application_v325["saved"],
            "verified": spectron_tscript_destructor_application_v325["verified"],
            "verified_name_count": spectron_tscript_destructor_application_v325["verified_name_count"],
        },
        {
            "anchor_count": 8,
            "resolved_count": 8,
            ...
            "saved": True,
            "verified": True,
            "verified_name_count": 8,
        },
    )
    check(
        "Spectron v325 TScript destructor reopen verification",
        {
            "anchor_count": spectron_tscript_destructor_verification_v325["anchor_count"],
            "failure_count": spectron_tscript_destructor_verification_v325["failure_count"],
            "function_count": spectron_tscript_destructor_verification_v325["function_count"],
            "verified": spectron_tscript_destructor_verification_v325["verified"],
            "verified_name_count": spectron_tscript_destructor_verification_v325["verified_name_count"],
        },
        {
            "anchor_count": 8,
            "failure_count": 0,
    ...
    coverage_v325_origins = spectron_name_coverage_v325["name_origins"]
    check(
        "Spectron v325 name audit input hash",
        spectron_name_coverage_v325["input_sha256"],
        "f57f7da48bcddf3738f15502328b36032313ad760eea04c5cc19ef82b4232219",
    )
    check(
        "Spectron v325 name audit function count",
        spectron_name_coverage_v325["function_count"],
        11707,
    )
    check(
        "Spectron v325 name audit default count",
        spectron_name_coverage_v325["default_name_count"],
        0,
    )
    check(
        "Spectron v325 name audit origin counts",
        coverage_v325_origins,
        {
            "ida_named_or_other": 4053,
            "target_jni_export": 7,
    ...
    check(
        "Spectron v325 dynamic boundary artifact",
        spectron_dynamic_boundaries_v325["artifact"],
        "spectron_dynamic_symbol_boundary_audit",
    )
    check(
        "Spectron v325 dynamic boundary network",
        spectron_dynamic_boundaries_v325["network_contacted"],
        False,
    )
    check(
        "Spectron v325 dynamic boundary input hash",
        spectron_dynamic_boundaries_v325["input_sha256"],
        "f57f7da48bcddf3738f15502328b36032313ad760eea04c5cc19ef82b4232219",
    )
    check(
        "Spectron v325 dynamic boundary counts",
        {
            "defined_function_symbol_count": spectron_dynamic_boundaries_v325["defined_function_symbol_count"],
            "ida_exact_start_count": spectron_dynamic_boundaries_v325["ida_exact_start_count"],
            "ida_missing_exact_start_count": spectron_dynamic_boundaries_v325["ida_missing_exact_start_count"],
            "row_count": len(spectron_dynamic_boundaries_v325["rows"]),
        },
        {
            "defined_function_symbol_count": 5782,
            "ida_exact_start_count": 5782,
    ...
    dynamic_symbol_coverage_v325_summary = spectron_dynamic_symbol_coverage_v325["summary"]
    check(
        "Spectron v325 dynamic symbol coverage artifact",
        spectron_dynamic_symbol_coverage_v325["artifact"],
        "spectron_dynamic_symbol_coverage_audit_20260828",
    )
    check(
        "Spectron v325 dynamic symbol coverage network",
        spectron_dynamic_symbol_coverage_v325["network_contacted"],
        False,
    )
    check(
        "Spectron v325 dynamic symbol coverage input hash",
        spectron_dynamic_symbol_coverage_v325["input_sha256"],
        "f57f7da48bcddf3738f15502328b36032313ad760eea04c5cc19ef82b4232219",
    )
    check(
        "Spectron v325 dynamic symbol coverage summary",
        dynamic_symbol_coverage_v325_summary,
        {
            "defined_named_symbol_count": 6600,
            "location_counts": {
                "ida_data_item": 482,
    ...
    check(
        "Spectron v325 checkpoint artifact",
        spectron_checkpoint_v325["artifact"],
        "spectron_translation_checkpoint_20260829_v325",
    )
    check(
        "Spectron v325 checkpoint parent",
        spectron_checkpoint_v325["parent_checkpoint"]["artifact"],
        "spectron_translation_checkpoint_20260829_v324",
    )
    check(
        "Spectron v325 checkpoint database hash",
        spectron_checkpoint_v325["database"]["sha256"],
        "229e4729eed1be2759935c1604ac6e3987ffe6fbe91c2b5a0dca16ae344c0757",
    )
    check(
        "Spectron v325 checkpoint database close-reopen",
        spectron_checkpoint_v325["database"]["close_reopen_verified"],
        True,
    )
    check(
        "Spectron v325 checkpoint function count",
        spectron_checkpoint_v325["database"]["function_count"],
        11707,
    )
    check(
        "Spectron v325 checkpoint default names",
        spectron_checkpoint_v325["database"]["default_name_count"],
        0,
    )
    check(
        "Spectron v325 checkpoint TScript destructor translation",
        {
            "anchor_count": spectron_checkpoint_v325["tscript_destructor_translation_v325"]["anchor_count"],
            "high_confidence_count": spectron_checkpoint_v325["tscript_destructor_translation_v325"]["high_confidence_count"],
            "layout_change_anchor_count": spectron_checkpoint_v325["tscript_destructor_translation_v325"]["layout_change_anchor_count"],
            "reopen_verified": spectron_checkpoint_v325["tscript_destructor_translation_v325"]["reopen_verified"],
        },
        {
            "anchor_count": 8,
            "high_confidence_count": 8,
    ...
    check(
        "Spectron v326 format/property anchor artifact",
        spectron_format_parameters_property_anchors_v326["artifact"],
        "spectron_format_parameters_property_manual_translation_anchors_20260829",
    )
    check(
        "Spectron v326 format/property anchor network",
        spectron_format_parameters_property_anchors_v326["network_contacted"],
        False,
    )
    check(
        "Spectron v326 format/property anchor summary",
        spectron_format_parameters_property_anchors_v326["summary"],
        {
            "anchor_count": 20,
    ...
    check(
        "Spectron v326 format/property source aliases",
        [
            row["proposed_name"]
            for row in spectron_format_parameters_property_anchors_v326["anchors"]
        ],
        [
            "v18_TScriptMachine_FormatParameters_TScriptMachine_FormatParameters",
            "v18_TCallStackEntryProperties_TCallStackEntryProperties",
            "v18_non_virtual_thunk_to_TCallStackEntryProperties_TCallStackEntryProperties",
            "v18_TCallStackEntryProperties_TCallStackEntryProperties__2",
            "v18_non_virtual_thunk_to_TCallStackEntryProperties_TCallStackEntryProperties__2",
            "v18_TScriptMachine_FormatParameters_TScriptMachine_FormatParameters__2",
            "v18_TScriptMachine_FormatParameters_getNextU32_void",
            "v18_TScriptMachine_FormatParameters_getNextS32_void",
            "v18_TScriptMachine_FormatParameters_getNextF64_void",
            "v18_TScriptMachine_FormatParameters_getIndexedU32_int",
            "v18_TScriptMachine_FormatParameters_getIndexedS32_int",
            "v18_TScriptMachine_FormatParameters_getIndexedF64_int",
            "v18_TScriptMachine_FormatParameters_getNextString_void",
            "v18_TScriptMachine_FormatParameters_getIndexedString_int",
            "v18_TProperties_TProperties",
            "v18_non_virtual_thunk_to_TProperties_TProperties",
            "v18_TProperties_TProperties__2",
            "v18_non_virtual_thunk_to_TProperties_TProperties__2",
            "v18_TJoinedClassesProperty_writeObject_TGraalVar_TGraalVar",
            "v18_TAniProperty_writeObject_TGraalVar_TGraalVar",
        ],
    )
    check(
        "Spectron v326 format/property target addresses",
        [
            row["spectron_ea"]
            for row in spectron_format_parameters_property_anchors_v326["anchors"]
        ],
    ...
    check(
        "Spectron v326 format/property application artifact",
        spectron_format_parameters_property_application_v326["artifact"],
        "spectron_manual_anchor_application",
    )
    check(
        "Spectron v326 format/property application counts",
        {
            "anchor_count": spectron_format_parameters_property_application_v326["anchor_count"],
            "resolved_count": spectron_format_parameters_property_application_v326["resolved_count"],
            "renamed_count": spectron_format_parameters_property_application_v326["renamed_count"],
            "comments_added": spectron_format_parameters_property_application_v326["comments_added"],
            "failure_count": spectron_format_parameters_property_application_v326["failure_count"],
            "saved": spectron_format_parameters_property_application_v326["saved"],
            "verified": spectron_format_parameters_property_application_v326["verified"],
            "verified_name_count": spectron_format_parameters_property_application_v326["verified_name_count"],
        },
        {
            "anchor_count": 20,
            "resolved_count": 20,
            ...
            "saved": True,
            "verified": True,
            "verified_name_count": 20,
        },
    )
    check(
        "Spectron v326 format/property reopen verification",
        {
            "anchor_count": spectron_format_parameters_property_verification_v326["anchor_count"],
            "failure_count": spectron_format_parameters_property_verification_v326["failure_count"],
            "function_count": spectron_format_parameters_property_verification_v326["function_count"],
            "verified": spectron_format_parameters_property_verification_v326["verified"],
            "verified_name_count": spectron_format_parameters_property_verification_v326["verified_name_count"],
        },
        {
            "anchor_count": 20,
            "failure_count": 0,
    ...
    coverage_v326_origins = spectron_name_coverage_v326["name_origins"]
    check(
        "Spectron v326 name audit input hash",
        spectron_name_coverage_v326["input_sha256"],
        "f57f7da48bcddf3738f15502328b36032313ad760eea04c5cc19ef82b4232219",
    )
    check(
        "Spectron v326 name audit function count",
        spectron_name_coverage_v326["function_count"],
        11707,
    )
    check(
        "Spectron v326 name audit default count",
        spectron_name_coverage_v326["default_name_count"],
        0,
    )
    check(
        "Spectron v326 name audit origin counts",
        coverage_v326_origins,
        {
            "ida_named_or_other": 4053,
            "target_jni_export": 7,
    ...
    check(
        "Spectron v326 dynamic boundary artifact",
        spectron_dynamic_boundaries_v326["artifact"],
        "spectron_dynamic_symbol_boundary_audit",
    )
    check(
        "Spectron v326 dynamic boundary network",
        spectron_dynamic_boundaries_v326["network_contacted"],
        False,
    )
    check(
        "Spectron v326 dynamic boundary input hash",
        spectron_dynamic_boundaries_v326["input_sha256"],
        "f57f7da48bcddf3738f15502328b36032313ad760eea04c5cc19ef82b4232219",
    )
    check(
        "Spectron v326 dynamic boundary counts",
        {
            "defined_function_symbol_count": spectron_dynamic_boundaries_v326["defined_function_symbol_count"],
            "ida_exact_start_count": spectron_dynamic_boundaries_v326["ida_exact_start_count"],
            "ida_missing_exact_start_count": spectron_dynamic_boundaries_v326["ida_missing_exact_start_count"],
            "row_count": len(spectron_dynamic_boundaries_v326["rows"]),
        },
        {
            "defined_function_symbol_count": 5782,
            "ida_exact_start_count": 5782,
    ...
    dynamic_symbol_coverage_v326_summary = spectron_dynamic_symbol_coverage_v326["summary"]
    check(
        "Spectron v326 dynamic symbol coverage artifact",
        spectron_dynamic_symbol_coverage_v326["artifact"],
        "spectron_dynamic_symbol_coverage_audit_20260828",
    )
    check(
        "Spectron v326 dynamic symbol coverage network",
        spectron_dynamic_symbol_coverage_v326["network_contacted"],
        False,
    )
    check(
        "Spectron v326 dynamic symbol coverage input hash",
        spectron_dynamic_symbol_coverage_v326["input_sha256"],
        "f57f7da48bcddf3738f15502328b36032313ad760eea04c5cc19ef82b4232219",
    )
    check(
        "Spectron v326 dynamic symbol coverage summary",
        dynamic_symbol_coverage_v326_summary,
        {
            "defined_named_symbol_count": 6600,
            "location_counts": {
                "ida_data_item": 482,
    ...
    check(
        "Spectron v326 semantic translation summary",
        {
            "artifact": spectron_semantic_translation_v326["artifact"],
            "network_contacted": spectron_semantic_translation_v326["network_contacted"],
            "summary": spectron_semantic_translation_v326["summary"],
        },
        {
    ...
    check(
        "Spectron v326 checkpoint artifact",
        spectron_checkpoint_v326["artifact"],
        "spectron_translation_checkpoint_20260829_v326",
    )
    check(
        "Spectron v326 checkpoint parent",
        spectron_checkpoint_v326["parent_checkpoint"]["artifact"],
        "spectron_translation_checkpoint_20260829_v325",
    )
    check(
        "Spectron v326 checkpoint database hash",
        spectron_checkpoint_v326["database"]["sha256"],
        "08ae63229dfbcabf94d314cda677a2c45b60e17b9c2fee8351a298b3cf6eb991",
    )
    check(
        "Spectron v326 checkpoint database close-reopen",
        spectron_checkpoint_v326["database"]["close_reopen_verified"],
        True,
    )
    check(
        "Spectron v326 checkpoint function count",
        spectron_checkpoint_v326["database"]["function_count"],
        11707,
    )
    check(
        "Spectron v326 checkpoint default names",
        spectron_checkpoint_v326["database"]["default_name_count"],
        0,
    )
    check(
        "Spectron v326 format/property translation",
        {
            "anchor_count": spectron_checkpoint_v326["format_parameters_property_translation_v326"]["anchor_count"],
            "high_confidence_count": spectron_checkpoint_v326["format_parameters_property_translation_v326"]["high_confidence_count"],
            "exact_metric_anchor_count": spectron_checkpoint_v326["format_parameters_property_translation_v326"]["exact_metric_anchor_count"],
            "layout_change_anchor_count": spectron_checkpoint_v326["format_parameters_property_translation_v326"]["layout_change_anchor_count"],
            "reopen_verified": spectron_checkpoint_v326["format_parameters_property_translation_v326"]["reopen_verified"],
        },
        {
            "anchor_count": 20,
            "high_confidence_count": 20,
    ...
    check(
        "Spectron v327 property constructor/destructor anchor artifact",
        spectron_property_constructor_destructor_anchors_v327["artifact"],
        "spectron_property_constructor_destructor_manual_translation_anchors_20260829",
    )
    check(
        "Spectron v327 property constructor/destructor anchor network",
        spectron_property_constructor_destructor_anchors_v327["network_contacted"],
        False,
    )
    check(
        "Spectron v327 property constructor/destructor anchor summary",
        spectron_property_constructor_destructor_anchors_v327["summary"],
        {
            "anchor_count": 15,
            "exact_metric_anchor_count": 0,
            "high_confidence_count": 15,
            "layout_change_anchor_count": 15,
            "new_context_anchor_count": 15,
            "source_pseudocode_count": 15,
            "target_pseudocode_count": 15,
        },
    )
    check(
        "Spectron v327 property constructor/destructor source aliases",
        [
            row["proposed_name"]
            for row in spectron_property_constructor_destructor_anchors_v327["anchors"]
        ],
        [
            "v18_TProperties_TProperties_TString_const_TString_const",
            "v18_TProperties_compileProperties_void",
            "v18_getPropertyList_TString_const",
            "v18_TObjectCreator_TObjectCreator_TString_const_TGraalVar_TString_const",
            "v18_TScriptProperty_initStaticScriptVars_void",
            "v18_TObjectCreator_TObjectCreator",
            "v18_TObjectCreator_TObjectCreator__2",
            "v18_TScriptProperty_TScriptProperty",
            "v18_TScriptProperty_TScriptProperty__2",
            "v18_TAniProperty_TAniProperty",
            "v18_TAniProperty_TAniProperty__2",
            "v18_TJoinedClassesProperty_TJoinedClassesProperty",
            "v18_TJoinedClassesProperty_TJoinedClassesProperty__2",
            "v18_TAcceptStringProperty_TAcceptStringProperty",
            "v18_TAcceptStringProperty_TAcceptStringProperty__2",
        ],
    )
    check(
        "Spectron v327 property constructor/destructor target addresses",
        [
            row["spectron_ea"]
            for row in spectron_property_constructor_destructor_anchors_v327["anchors"]
        ],
    ...
    check(
        "Spectron v327 property constructor/destructor application artifact",
        spectron_property_constructor_destructor_application_v327["artifact"],
        "spectron_manual_anchor_application",
    )
    check(
        "Spectron v327 property constructor/destructor application counts",
        {
            "anchor_count": spectron_property_constructor_destructor_application_v327["anchor_count"],
            "resolved_count": spectron_property_constructor_destructor_application_v327["resolved_count"],
            "renamed_count": spectron_property_constructor_destructor_application_v327["renamed_count"],
            "comments_added": spectron_property_constructor_destructor_application_v327["comments_added"],
            "failure_count": spectron_property_constructor_destructor_application_v327["failure_count"],
            "saved": spectron_property_constructor_destructor_application_v327["saved"],
            "verified": spectron_property_constructor_destructor_application_v327["verified"],
            "verified_name_count": spectron_property_constructor_destructor_application_v327["verified_name_count"],
        },
        {
            "anchor_count": 15,
            "resolved_count": 15,
            ...
            "saved": True,
            "verified": True,
            "verified_name_count": 15,
        },
    )
    check(
        "Spectron v327 property constructor/destructor reopen verification",
        {
            "anchor_count": spectron_property_constructor_destructor_verification_v327["anchor_count"],
            "failure_count": spectron_property_constructor_destructor_verification_v327["failure_count"],
            "function_count": spectron_property_constructor_destructor_verification_v327["function_count"],
            "verified": spectron_property_constructor_destructor_verification_v327["verified"],
            "verified_name_count": spectron_property_constructor_destructor_verification_v327["verified_name_count"],
        },
        {
            "anchor_count": 15,
            "failure_count": 0,
    ...
    coverage_v327_origins = spectron_name_coverage_v327["name_origins"]
    check(
        "Spectron v327 name audit input hash",
        spectron_name_coverage_v327["input_sha256"],
        "f57f7da48bcddf3738f15502328b36032313ad760eea04c5cc19ef82b4232219",
    )
    check(
        "Spectron v327 name audit function count",
        spectron_name_coverage_v327["function_count"],
        11707,
    )
    check(
        "Spectron v327 name audit default count",
        spectron_name_coverage_v327["default_name_count"],
        0,
    )
    check(
        "Spectron v327 name audit origin counts",
        coverage_v327_origins,
        {
            "ida_named_or_other": 4053,
            "target_jni_export": 7,
            "target_named_export": 900,
            "target_only_descriptive": 417,
            "translated_v18_alias": 6330,
        },
    )
    check(
        "Spectron v327 dynamic boundary artifact",
        spectron_dynamic_boundaries_v327["artifact"],
        "spectron_dynamic_symbol_boundary_audit",
    )
    check(
        "Spectron v327 dynamic boundary network",
        spectron_dynamic_boundaries_v327["network_contacted"],
        False,
    )
    check(
        "Spectron v327 dynamic boundary input hash",
        spectron_dynamic_boundaries_v327["input_sha256"],
        "f57f7da48bcddf3738f15502328b36032313ad760eea04c5cc19ef82b4232219",
    )
    check(
        "Spectron v327 dynamic boundary counts",
        {
            "defined_function_symbol_count": spectron_dynamic_boundaries_v327["defined_function_symbol_count"],
            "ida_exact_start_count": spectron_dynamic_boundaries_v327["ida_exact_start_count"],
            "ida_missing_exact_start_count": spectron_dynamic_boundaries_v327["ida_missing_exact_start_count"],
            "row_count": len(spectron_dynamic_boundaries_v327["rows"]),
        },
        {
            "defined_function_symbol_count": 5782,
            "ida_exact_start_count": 5782,
    ...
    dynamic_symbol_coverage_v327_summary = spectron_dynamic_symbol_coverage_v327["summary"]
    check(
        "Spectron v327 dynamic symbol coverage artifact",
        spectron_dynamic_symbol_coverage_v327["artifact"],
        "spectron_dynamic_symbol_coverage_audit_20260828",
    )
    check(
        "Spectron v327 dynamic symbol coverage network",
        spectron_dynamic_symbol_coverage_v327["network_contacted"],
        False,
    )
    check(
        "Spectron v327 dynamic symbol coverage input hash",
        spectron_dynamic_symbol_coverage_v327["input_sha256"],
        "f57f7da48bcddf3738f15502328b36032313ad760eea04c5cc19ef82b4232219",
    )
    check(
        "Spectron v327 dynamic symbol coverage summary",
        dynamic_symbol_coverage_v327_summary,
        {
            "defined_named_symbol_count": 6600,
            "location_counts": {
                "ida_data_item": 482,
            ...
            "name_match_counts": {
                "item_name_match": 1788,
                "item_name_mismatch": 4982,
                "value_name_match": 1788,
                "value_name_mismatch": 4982,
            },
            "named_dynamic_symbol_count": 6770,
            "status_counts": {
                "exact_retained_dynamic_name": 1788,
                "linker_boundary_alias_mismatch": 7,
                "other_retained_target_name": 136,
                "source_backed_v18_alias": 4669,
                "undefined_import_with_plt_stub": 169,
                "undefined_no_target_address": 1,
            },
        },
    ...
    check(
        "Spectron v327 semantic translation summary",
        {
            "artifact": spectron_semantic_translation_v327["artifact"],
            "network_contacted": spectron_semantic_translation_v327["network_contacted"],
            "summary": spectron_semantic_translation_v327["summary"],
        },
        {
            "artifact": "spectron_semantic_function_translation",
            "network_contacted": False,
    ...
    check(
        "Spectron v327 checkpoint artifact",
        spectron_checkpoint_v327["artifact"],
        "spectron_translation_checkpoint_20260829_v327",
    )
    check(
        "Spectron v327 checkpoint parent",
        spectron_checkpoint_v327["parent_checkpoint"]["artifact"],
        "spectron_translation_checkpoint_20260829_v326",
    )
    check(
        "Spectron v327 checkpoint database hash",
        spectron_checkpoint_v327["database"]["sha256"],
        "cc731360c7c08f825a7905c760897d3a7aede1dccdb4322d56d72f5c2e0c2f13",
    )
    check(
        "Spectron v327 checkpoint database close-reopen",
        spectron_checkpoint_v327["database"]["close_reopen_verified"],
        True,
    )
    check(
        "Spectron v327 checkpoint function count",
        spectron_checkpoint_v327["database"]["function_count"],
        11707,
    )
    check(
        "Spectron v327 checkpoint default names",
        spectron_checkpoint_v327["database"]["default_name_count"],
        0,
    )
    check(
        "Spectron v327 property constructor/destructor translation",
        {
            "anchor_count": spectron_checkpoint_v327["property_constructor_destructor_translation_v327"]["anchor_count"],
            "high_confidence_count": spectron_checkpoint_v327["property_constructor_destructor_translation_v327"]["high_confidence_count"],
            "exact_metric_anchor_count": spectron_checkpoint_v327["property_constructor_destructor_translation_v327"]["exact_metric_anchor_count"],
            "layout_change_anchor_count": spectron_checkpoint_v327["property_constructor_destructor_translation_v327"]["layout_change_anchor_count"],
            "reopen_verified": spectron_checkpoint_v327["property_constructor_destructor_translation_v327"]["reopen_verified"],
        },
        {
            "anchor_count": 15,
            "high_confidence_count": 15,
    ...
    check(
        "Spectron v328 script-machine static-tail anchor artifact",
        spectron_script_machine_static_tail_anchors_v328["artifact"],
        "spectron_script_machine_static_tail_manual_translation_anchors_20260829",
    )
    check(
        "Spectron v328 script-machine static-tail anchor network",
        spectron_script_machine_static_tail_anchors_v328["network_contacted"],
        False,
    )
    check(
        "Spectron v328 script-machine static-tail anchor summary",
        spectron_script_machine_static_tail_anchors_v328["summary"],
        {
            "anchor_count": 2,
    ...
    check(
        "Spectron v328 script-machine static-tail source aliases",
        [
            row["proposed_name"]
            for row in spectron_script_machine_static_tail_anchors_v328["anchors"]
        ],
        [
    ...
    check(
        "Spectron v328 script-machine static-tail target addresses",
        [
            row["spectron_ea"]
            for row in spectron_script_machine_static_tail_anchors_v328["anchors"]
        ],
    ...
    check(
        "Spectron v328 script-machine static-tail application artifact",
        spectron_script_machine_static_tail_application_v328["artifact"],
        "spectron_manual_anchor_application",
    )
    check(
        "Spectron v328 script-machine static-tail application counts",
        {
            "anchor_count": spectron_script_machine_static_tail_application_v328["anchor_count"],
            "resolved_count": spectron_script_machine_static_tail_application_v328["resolved_count"],
            "renamed_count": spectron_script_machine_static_tail_application_v328["renamed_count"],
            "comments_added": spectron_script_machine_static_tail_application_v328["comments_added"],
            "failure_count": spectron_script_machine_static_tail_application_v328["failure_count"],
            "saved": spectron_script_machine_static_tail_application_v328["saved"],
            "verified": spectron_script_machine_static_tail_application_v328["verified"],
            "verified_name_count": spectron_script_machine_static_tail_application_v328["verified_name_count"],
        },
        {
            "anchor_count": 2,
            "resolved_count": 2,
    ...
    check(
        "Spectron v328 script-machine static-tail reopen verification",
        {
            "anchor_count": spectron_script_machine_static_tail_verification_v328["anchor_count"],
            "failure_count": spectron_script_machine_static_tail_verification_v328["failure_count"],
            "function_count": spectron_script_machine_static_tail_verification_v328["function_count"],
            "verified": spectron_script_machine_static_tail_verification_v328["verified"],
            "verified_name_count": spectron_script_machine_static_tail_verification_v328["verified_name_count"],
        },
        {
            "anchor_count": 2,
            "failure_count": 0,
    ...
    coverage_v328_origins = spectron_name_coverage_v328["name_origins"]
    check(
        "Spectron v328 name audit input hash",
        spectron_name_coverage_v328["input_sha256"],
        "f57f7da48bcddf3738f15502328b36032313ad760eea04c5cc19ef82b4232219",
    )
    check(
        "Spectron v328 name audit function count",
        spectron_name_coverage_v328["function_count"],
        11707,
    )
    check(
        "Spectron v328 name audit default count",
        spectron_name_coverage_v328["default_name_count"],
        0,
    )
    check(
        "Spectron v328 name audit origin counts",
        coverage_v328_origins,
        {
            "ida_named_or_other": 4053,
            "target_jni_export": 7,
    ...
    check(
        "Spectron v328 dynamic boundary artifact",
        spectron_dynamic_boundaries_v328["artifact"],
        "spectron_dynamic_symbol_boundary_audit",
    )
    check(
        "Spectron v328 dynamic boundary network",
        spectron_dynamic_boundaries_v328["network_contacted"],
        False,
    )
    check(
        "Spectron v328 dynamic boundary input hash",
        spectron_dynamic_boundaries_v328["input_sha256"],
        "f57f7da48bcddf3738f15502328b36032313ad760eea04c5cc19ef82b4232219",
    )
    check(
        "Spectron v328 dynamic boundary counts",
        {
            "defined_function_symbol_count": spectron_dynamic_boundaries_v328["defined_function_symbol_count"],
            "ida_exact_start_count": spectron_dynamic_boundaries_v328["ida_exact_start_count"],
            "ida_missing_exact_start_count": spectron_dynamic_boundaries_v328["ida_missing_exact_start_count"],
            "row_count": len(spectron_dynamic_boundaries_v328["rows"]),
        },
        {
            "defined_function_symbol_count": 5782,
            "ida_exact_start_count": 5782,
    ...
    dynamic_symbol_coverage_v328_summary = spectron_dynamic_symbol_coverage_v328["summary"]
    check(
        "Spectron v328 dynamic symbol coverage artifact",
        spectron_dynamic_symbol_coverage_v328["artifact"],
        "spectron_dynamic_symbol_coverage_audit_20260828",
    )
    check(
        "Spectron v328 dynamic symbol coverage network",
        spectron_dynamic_symbol_coverage_v328["network_contacted"],
        False,
    )
    check(
        "Spectron v328 dynamic symbol coverage input hash",
        spectron_dynamic_symbol_coverage_v328["input_sha256"],
        "f57f7da48bcddf3738f15502328b36032313ad760eea04c5cc19ef82b4232219",
    )
    check(
        "Spectron v328 dynamic symbol coverage summary",
        dynamic_symbol_coverage_v328_summary,
        {
            "defined_named_symbol_count": 6600,
            "location_counts": {
                "ida_data_item": 482,
    ...
    check(
        "Spectron v328 semantic translation summary",
        {
            "artifact": spectron_semantic_translation_v328["artifact"],
            "network_contacted": spectron_semantic_translation_v328["network_contacted"],
            "summary": spectron_semantic_translation_v328["summary"],
        },
        {
            "artifact": "spectron_semantic_function_translation",
            "network_contacted": False,
    ...
    check(
        "Spectron v328 checkpoint artifact",
        spectron_checkpoint_v328["artifact"],
        "spectron_translation_checkpoint_20260829_v328",
    )
    check(
        "Spectron v328 checkpoint parent",
        spectron_checkpoint_v328["parent_checkpoint"]["artifact"],
        "spectron_translation_checkpoint_20260829_v327",
    )
    check(
        "Spectron v328 checkpoint database hash",
        spectron_checkpoint_v328["database"]["sha256"],
        "01e5dc66c7446c46101a09486f23c1a86822e9973b57b5897fa93a4d1f11526a",
    )
    check(
        "Spectron v328 checkpoint database close-reopen",
        spectron_checkpoint_v328["database"]["close_reopen_verified"],
        True,
    )
    check(
        "Spectron v328 checkpoint function count",
        spectron_checkpoint_v328["database"]["function_count"],
        11707,
    )
    check(
        "Spectron v328 checkpoint default names",
        spectron_checkpoint_v328["database"]["default_name_count"],
        0,
    )
    check(
        "Spectron v328 script-machine static-tail translation",
        {
            "anchor_count": spectron_checkpoint_v328["script_machine_static_tail_translation_v328"]["anchor_count"],
            "high_confidence_count": spectron_checkpoint_v328["script_machine_static_tail_translation_v328"]["high_confidence_count"],
            "exact_metric_anchor_count": spectron_checkpoint_v328["script_machine_static_tail_translation_v328"]["exact_metric_anchor_count"],
            "layout_change_anchor_count": spectron_checkpoint_v328["script_machine_static_tail_translation_v328"]["layout_change_anchor_count"],
            "reopen_verified": spectron_checkpoint_v328["script_machine_static_tail_translation_v328"]["reopen_verified"],
        },
        {
            "anchor_count": 2,
            "high_confidence_count": 2,
    ...
    check(
        "Spectron v329 TScriptSpace residual anchor artifact",
        spectron_tscript_space_residual_anchors_v329["artifact"],
        "spectron_tscript_space_residual_manual_translation_anchors_20260829",
    )
    check(
        "Spectron v329 TScriptSpace residual anchor network",
        spectron_tscript_space_residual_anchors_v329["network_contacted"],
        False,
    )
    check(
        "Spectron v329 TScriptSpace residual anchor summary",
        spectron_tscript_space_residual_anchors_v329["summary"],
        {
            "anchor_count": 2,
            "exact_metric_anchor_count": 1,
            "high_confidence_count": 2,
    ...
    check(
        "Spectron v329 TScriptSpace residual source aliases",
        [row["proposed_name"] for row in spectron_tscript_space_residual_anchors_v329["anchors"]],
        [
    ...
    check(
        "Spectron v329 TScriptSpace residual target addresses",
        [row["spectron_ea"] for row in spectron_tscript_space_residual_anchors_v329["anchors"]],
        ["0x230198", "0x233114"],
    )
    check(
        "Spectron v329 TScriptSpace residual application artifact",
        spectron_tscript_space_residual_application_v329["artifact"],
        "spectron_manual_anchor_application",
    )
    check(
        "Spectron v329 TScriptSpace residual application counts",
        {
            "anchor_count": spectron_tscript_space_residual_application_v329["anchor_count"],
            "resolved_count": spectron_tscript_space_residual_application_v329["resolved_count"],
            "renamed_count": spectron_tscript_space_residual_application_v329["renamed_count"],
            "comments_added": spectron_tscript_space_residual_application_v329["comments_added"],
            "failure_count": spectron_tscript_space_residual_application_v329["failure_count"],
            "saved": spectron_tscript_space_residual_application_v329["saved"],
            "verified": spectron_tscript_space_residual_application_v329["verified"],
            "verified_name_count": spectron_tscript_space_residual_application_v329["verified_name_count"],
        },
        {
            "anchor_count": 2,
            "resolved_count": 2,
    ...
    check(
        "Spectron v329 TScriptSpace residual reopen verification",
        {
            "anchor_count": spectron_tscript_space_residual_verification_v329["anchor_count"],
            "failure_count": spectron_tscript_space_residual_verification_v329["failure_count"],
            "function_count": spectron_tscript_space_residual_verification_v329["function_count"],
            "verified": spectron_tscript_space_residual_verification_v329["verified"],
            "verified_name_count": spectron_tscript_space_residual_verification_v329["verified_name_count"],
        },
        {
            "anchor_count": 2,
            "failure_count": 0,
    ...
    check(
        "Spectron v329 TScriptSpace residual label artifact",
        spectron_tscript_space_residual_labels_v329["artifact"],
        "spectron_tscript_space_residual_labels_20260829",
    )
    check(
        "Spectron v329 TScriptSpace residual label summary",
        spectron_tscript_space_residual_labels_v329["summary"],
        {
            "high_confidence_count": 2,
            "label_count": 2,
    ...
    check(
        "Spectron v329 TScriptSpace residual labels",
        [row["proposed_name"] for row in spectron_tscript_space_residual_labels_v329["labels"]],
        [
    ...
    check(
        "Spectron v329 TScriptSpace residual label application",
        {
            "apply": spectron_tscript_space_residual_label_application_v329["apply"],
            "label_count": spectron_tscript_space_residual_label_application_v329["label_count"],
            "resolved_count": spectron_tscript_space_residual_label_application_v329["resolved_count"],
            "renamed_count": spectron_tscript_space_residual_label_application_v329["renamed_count"],
            "failure_count": spectron_tscript_space_residual_label_application_v329["failure_count"],
            "saved": spectron_tscript_space_residual_label_application_v329["saved"],
        },
        {
            "apply": True,
            "label_count": 2,
    ...
    check(
        "Spectron v329 TScriptSpace residual label verification",
        {
            "label_count": spectron_tscript_space_residual_label_verification_v329["label_count"],
            "failure_count": spectron_tscript_space_residual_label_verification_v329["failure_count"],
            "verified": spectron_tscript_space_residual_label_verification_v329["verified"],
            "verified_name_count": spectron_tscript_space_residual_label_verification_v329["verified_name_count"],
        },
        {
            "label_count": 2,
            "failure_count": 0,
    ...
    coverage_v329_origins = spectron_name_coverage_v329["name_origins"]
    check(
        "Spectron v329 name audit input hash",
        spectron_name_coverage_v329["input_sha256"],
        "f57f7da48bcddf3738f15502328b36032313ad760eea04c5cc19ef82b4232219",
    )
    check("Spectron v329 name audit function count", spectron_name_coverage_v329["function_count"], 11707)
    check("Spectron v329 name audit default count", spectron_name_coverage_v329["default_name_count"], 0)
    check(
        "Spectron v329 name audit origin counts",
        coverage_v329_origins,
        {
            "ida_named_or_other": 4053,
            "target_jni_export": 7,
    ...
    check(
        "Spectron v329 dynamic boundary counts",
        {
            "artifact": spectron_dynamic_boundaries_v329["artifact"],
            "network_contacted": spectron_dynamic_boundaries_v329["network_contacted"],
            "input_sha256": spectron_dynamic_boundaries_v329["input_sha256"],
            "defined_function_symbol_count": spectron_dynamic_boundaries_v329["defined_function_symbol_count"],
            "ida_exact_start_count": spectron_dynamic_boundaries_v329["ida_exact_start_count"],
            "ida_missing_exact_start_count": spectron_dynamic_boundaries_v329["ida_missing_exact_start_count"],
            "row_count": len(spectron_dynamic_boundaries_v329["rows"]),
        },
        {
    ...
    check(
        "Spectron v329 dynamic symbol coverage",
        {
            "artifact": spectron_dynamic_symbol_coverage_v329["artifact"],
            "network_contacted": spectron_dynamic_symbol_coverage_v329["network_contacted"],
            "input_sha256": spectron_dynamic_symbol_coverage_v329["input_sha256"],
            "summary": spectron_dynamic_symbol_coverage_v329["summary"],
        },
        {
    ...
    check(
        "Spectron v329 semantic translation summary",
        {
            "artifact": spectron_semantic_translation_v329["artifact"],
            "network_contacted": spectron_semantic_translation_v329["network_contacted"],
            "summary": spectron_semantic_translation_v329["summary"],
        },
        {
            "artifact": "spectron_semantic_function_translation",
            "network_contacted": False,
    ...
    check(
        "Spectron v329 checkpoint artifact",
        spectron_checkpoint_v329["artifact"],
        "spectron_translation_checkpoint_20260829_v329",
    )
    check(
        "Spectron v329 checkpoint parent",
        spectron_checkpoint_v329["parent_checkpoint"]["artifact"],
        "spectron_translation_checkpoint_20260829_v328",
    )
    check(
        "Spectron v329 checkpoint database",
        {
            "sha256": spectron_checkpoint_v329["database"]["sha256"],
            "close_reopen_verified": spectron_checkpoint_v329["database"]["close_reopen_verified"],
            "function_count": spectron_checkpoint_v329["database"]["function_count"],
            "default_name_count": spectron_checkpoint_v329["database"]["default_name_count"],
        },
        {
            "sha256": "c84c8bd4abe51302092c82db16003712e870b0ed8a541a9417f6c563f540b6ee",
    ...
    check(
        "Spectron v329 source translation checkpoint",
        {
            "anchor_count": spectron_checkpoint_v329["tscript_space_residual_translation_v329"]["anchor_count"],
            "high_confidence_count": spectron_checkpoint_v329["tscript_space_residual_translation_v329"]["high_confidence_count"],
            "exact_metric_anchor_count": spectron_checkpoint_v329["tscript_space_residual_translation_v329"]["exact_metric_anchor_count"],
            "layout_change_anchor_count": spectron_checkpoint_v329["tscript_space_residual_translation_v329"]["layout_change_anchor_count"],
            "semantic_promotion_count": spectron_checkpoint_v329["tscript_space_residual_translation_v329"]["semantic_promotion_count"],
            "reopen_verified": spectron_checkpoint_v329["tscript_space_residual_translation_v329"]["reopen_verified"],
        },
        {
            "anchor_count": 2,
            "high_confidence_count": 2,
    ...
    check(
        "Spectron v329 target-only checkpoint",
        {
            "label_count": spectron_checkpoint_v329["tscript_space_residual_target_only_labels_v329"]["label_count"],
            "high_confidence_count": spectron_checkpoint_v329["tscript_space_residual_target_only_labels_v329"]["high_confidence_count"],
            "reopen_verified": spectron_checkpoint_v329["tscript_space_residual_target_only_labels_v329"]["reopen_verified"],
        },
        {
            "label_count": 2,
            "high_confidence_count": 2,
    ...
    check(
        "Spectron v330 TScriptUniverse residual anchor artifact",
        spectron_tscript_universe_residual_anchors_v330["artifact"],
        "spectron_tscript_universe_residual_manual_translation_anchors_20260829",
    )
    check(
        "Spectron v330 TScriptUniverse residual anchor network",
        spectron_tscript_universe_residual_anchors_v330["network_contacted"],
        False,
    )
    check(
        "Spectron v330 TScriptUniverse residual anchor summary",
        spectron_tscript_universe_residual_anchors_v330["summary"],
        {
            "anchor_count": 6,
            "exact_metric_anchor_count": 4,
            "high_confidence_count": 6,
            "layout_change_anchor_count": 2,
            "new_context_anchor_count": 6,
            "semantic_promotion_count": 0,
            "source_pseudocode_count": 6,
            "target_pseudocode_count": 6,
        },
    )
    check(
        "Spectron v330 TScriptUniverse residual source aliases",
        [row["proposed_name"] for row in spectron_tscript_universe_residual_anchors_v330["anchors"]],
        [
            "v18_TScriptExecutionStats_TScriptExecutionStats__2",
            "v18_TScriptUniverse_setExecutingNPC_TServerNPC",
            "v18_TScriptUniverse_setExecutingPlayer_TServerPlayer",
            "v18_TScriptUniverse_removeStaticObject_TGraalVar",
            "v18_TScriptUniverse_addToFreeMachines_TScriptMachine",
            "v18_TScriptUniverse_TScriptUniverse__2",
        ],
    )
    check(
        "Spectron v330 TScriptUniverse residual target addresses",
        [row["spectron_ea"] for row in spectron_tscript_universe_residual_anchors_v330["anchors"]],
        ["0x234bc0", "0x234d98", "0x234db4", "0x235000", "0x235a50", "0x235bf8"],
    )
    check(
        "Spectron v330 TScriptUniverse residual application artifact",
        spectron_tscript_universe_residual_application_v330["artifact"],
        "spectron_manual_anchor_application",
    )
    check(
        "Spectron v330 TScriptUniverse residual application counts",
        {
            "anchor_count": spectron_tscript_universe_residual_application_v330["anchor_count"],
            "resolved_count": spectron_tscript_universe_residual_application_v330["resolved_count"],
            "renamed_count": spectron_tscript_universe_residual_application_v330["renamed_count"],
            "comments_added": spectron_tscript_universe_residual_application_v330["comments_added"],
            "failure_count": spectron_tscript_universe_residual_application_v330["failure_count"],
            "saved": spectron_tscript_universe_residual_application_v330["saved"],
            "verified": spectron_tscript_universe_residual_application_v330["verified"],
            "verified_name_count": spectron_tscript_universe_residual_application_v330["verified_name_count"],
        },
        {
            "anchor_count": 6,
            "resolved_count": 6,
            ...
            "saved": True,
            "verified": True,
            "verified_name_count": 6,
        },
    )
    check(
        "Spectron v330 TScriptUniverse residual reopen verification",
        {
            "anchor_count": spectron_tscript_universe_residual_verification_v330["anchor_count"],
            "failure_count": spectron_tscript_universe_residual_verification_v330["failure_count"],
            "function_count": spectron_tscript_universe_residual_verification_v330["function_count"],
            "verified": spectron_tscript_universe_residual_verification_v330["verified"],
            "verified_name_count": spectron_tscript_universe_residual_verification_v330["verified_name_count"],
        },
        {
            "anchor_count": 6,
            "failure_count": 0,
    ...
    coverage_v330_origins = spectron_name_coverage_v330["name_origins"]
    check(
        "Spectron v330 name audit input hash",
        spectron_name_coverage_v330["input_sha256"],
        "f57f7da48bcddf3738f15502328b36032313ad760eea04c5cc19ef82b4232219",
    )
    check("Spectron v330 name audit function count", spectron_name_coverage_v330["function_count"], 11707)
    check("Spectron v330 name audit default count", spectron_name_coverage_v330["default_name_count"], 0)
    check(
        "Spectron v330 name audit origin counts",
        coverage_v330_origins,
        {
            "ida_named_or_other": 4053,
            "target_jni_export": 7,
            "target_named_export": 888,
            "target_only_descriptive": 419,
            "translated_v18_alias": 6340,
        },
    )
    check(
        "Spectron v330 dynamic boundary counts",
        {
            "artifact": spectron_dynamic_boundaries_v330["artifact"],
            "network_contacted": spectron_dynamic_boundaries_v330["network_contacted"],
            "input_sha256": spectron_dynamic_boundaries_v330["input_sha256"],
            "defined_function_symbol_count": spectron_dynamic_boundaries_v330["defined_function_symbol_count"],
            "ida_exact_start_count": spectron_dynamic_boundaries_v330["ida_exact_start_count"],
            "ida_missing_exact_start_count": spectron_dynamic_boundaries_v330["ida_missing_exact_start_count"],
            "row_count": len(spectron_dynamic_boundaries_v330["rows"]),
        },
        {
            "artifact": "spectron_dynamic_symbol_boundary_audit",
            "network_contacted": False,
    ...
    check(
        "Spectron v330 dynamic symbol coverage",
        {
            "artifact": spectron_dynamic_symbol_coverage_v330["artifact"],
            "network_contacted": spectron_dynamic_symbol_coverage_v330["network_contacted"],
            "input_sha256": spectron_dynamic_symbol_coverage_v330["input_sha256"],
            "summary": spectron_dynamic_symbol_coverage_v330["summary"],
        },
        {
            "artifact": "spectron_dynamic_symbol_coverage_audit_20260828",
            "network_contacted": False,
            ...
            "summary": {
                ...
                "name_match_counts": {
                    "item_name_match": 1776,
                    "item_name_mismatch": 4994,
                    "value_name_match": 1776,
                    "value_name_mismatch": 4994,
                },
                "named_dynamic_symbol_count": 6770,
                "status_counts": {
                    "exact_retained_dynamic_name": 1776,
                    "linker_boundary_alias_mismatch": 7,
                    "other_retained_target_name": 136,
                    "source_backed_v18_alias": 4679,
                    "target_only_descriptive": 2,
                    "undefined_import_with_plt_stub": 169,
                    "undefined_no_target_address": 1,
                },
    ...
    check(
        "Spectron v330 semantic translation summary",
        {
            "artifact": spectron_semantic_translation_v330["artifact"],
            "network_contacted": spectron_semantic_translation_v330["network_contacted"],
            "summary": spectron_semantic_translation_v330["summary"],
        },
        {
            "artifact": "spectron_semantic_function_translation",
            "network_contacted": False,
    ...
    check(
        "Spectron v330 checkpoint artifact",
        spectron_checkpoint_v330["artifact"],
        "spectron_translation_checkpoint_20260829_v330",
    )
    check(
        "Spectron v330 checkpoint parent",
        spectron_checkpoint_v330["parent_checkpoint"]["artifact"],
        "spectron_translation_checkpoint_20260829_v329",
    )
    check(
        "Spectron v330 checkpoint database",
        {
            "sha256": spectron_checkpoint_v330["database"]["sha256"],
            "close_reopen_verified": spectron_checkpoint_v330["database"]["close_reopen_verified"],
            "function_count": spectron_checkpoint_v330["database"]["function_count"],
            "default_name_count": spectron_checkpoint_v330["database"]["default_name_count"],
        },
        {
            "sha256": "be32d09e08a76b3641beff951644ec78167fcc2735d5fc5ea58f9ee12acf97a1",
            "close_reopen_verified": True,
            "function_count": 11707,
            "default_name_count": 0,
        },
    ...
    check(
        "Spectron v330 TScriptUniverse checkpoint",
        {
            "anchor_count": spectron_checkpoint_v330["tscript_universe_residual_translation_v330"]["anchor_count"],
            "high_confidence_count": spectron_checkpoint_v330["tscript_universe_residual_translation_v330"]["high_confidence_count"],
            "exact_metric_anchor_count": spectron_checkpoint_v330["tscript_universe_residual_translation_v330"]["exact_metric_anchor_count"],
            "layout_change_anchor_count": spectron_checkpoint_v330["tscript_universe_residual_translation_v330"]["layout_change_anchor_count"],
            "new_context_anchor_count": spectron_checkpoint_v330["tscript_universe_residual_translation_v330"]["new_context_anchor_count"],
            "semantic_promotion_count": spectron_checkpoint_v330["tscript_universe_residual_translation_v330"]["semantic_promotion_count"],
            "reopen_verified": spectron_checkpoint_v330["tscript_universe_residual_translation_v330"]["reopen_verified"],
        },
        {
            "anchor_count": 6,
            "high_confidence_count": 6,
    ...
    check(
        "Spectron v332 TPanelOperation residual anchor artifact",
        spectron_paneloperation_residual_anchors_v332["artifact"],
        "spectron_paneloperation_residual_manual_translation_anchors_20260829",
    )
    check(
        "Spectron v332 TPanelOperation residual anchor network",
        spectron_paneloperation_residual_anchors_v332["network_contacted"],
        False,
    )
    check(
        "Spectron v332 TPanelOperation residual anchor summary",
        spectron_paneloperation_residual_anchors_v332["summary"],
        {
            "anchor_count": 20,
    ...
    check(
        "Spectron v332 TPanelOperation residual source aliases",
        [row["proposed_name"] for row in spectron_paneloperation_residual_anchors_v332["anchors"]],
        [
    ...
    check(
        "Spectron v332 TPanelOperation residual target addresses",
        [row["spectron_ea"] for row in spectron_paneloperation_residual_anchors_v332["anchors"]],
        [
            "0x11d318",
            "0x11d344",
            "0x11d3d4",
    ...
    check(
        "Spectron v332 TPanelOperation residual application counts",
        {
            "artifact": spectron_paneloperation_residual_application_v332["artifact"],
            "anchor_count": spectron_paneloperation_residual_application_v332["anchor_count"],
            "resolved_count": spectron_paneloperation_residual_application_v332["resolved_count"],
            "renamed_count": spectron_paneloperation_residual_application_v332["renamed_count"],
            "comments_added": spectron_paneloperation_residual_application_v332["comments_added"],
            "failure_count": spectron_paneloperation_residual_application_v332["failure_count"],
            "saved": spectron_paneloperation_residual_application_v332["saved"],
            "verified": spectron_paneloperation_residual_application_v332["verified"],
            "verified_name_count": spectron_paneloperation_residual_application_v332["verified_name_count"],
        },
        {
    ...
    check(
        "Spectron v332 TPanelOperation residual reopen verification",
        {
            "artifact": spectron_paneloperation_residual_verification_v332["artifact"],
            "anchor_count": spectron_paneloperation_residual_verification_v332["anchor_count"],
            "failure_count": spectron_paneloperation_residual_verification_v332["failure_count"],
            "function_count": spectron_paneloperation_residual_verification_v332["function_count"],
            "verified": spectron_paneloperation_residual_verification_v332["verified"],
            "verified_name_count": spectron_paneloperation_residual_verification_v332["verified_name_count"],
        },
        {
    ...
    check(
        "Spectron v332 name audit",
        {
            "artifact": spectron_name_coverage_v332["artifact"],
            "network_contacted": spectron_name_coverage_v332["network_contacted"],
            "input_sha256": spectron_name_coverage_v332["input_sha256"],
            "function_count": spectron_name_coverage_v332["function_count"],
            "default_name_count": spectron_name_coverage_v332["default_name_count"],
            "name_origins": spectron_name_coverage_v332["name_origins"],
        },
        {
            "artifact": "spectron_name_coverage_audit",
            "network_contacted": False,
    ...
    check(
        "Spectron v332 dynamic boundary counts",
        {
            "artifact": spectron_dynamic_boundaries_v332["artifact"],
            "network_contacted": spectron_dynamic_boundaries_v332["network_contacted"],
            "input_sha256": spectron_dynamic_boundaries_v332["input_sha256"],
            "defined_function_symbol_count": spectron_dynamic_boundaries_v332["defined_function_symbol_count"],
            "ida_exact_start_count": spectron_dynamic_boundaries_v332["ida_exact_start_count"],
            "ida_missing_exact_start_count": spectron_dynamic_boundaries_v332["ida_missing_exact_start_count"],
            "row_count": len(spectron_dynamic_boundaries_v332["rows"]),
        },
        {
            "artifact": "spectron_dynamic_symbol_boundary_audit",
            "network_contacted": False,
    ...
    check(
        "Spectron v332 dynamic symbol coverage",
        {
            "artifact": spectron_dynamic_symbol_coverage_v332["artifact"],
            "network_contacted": spectron_dynamic_symbol_coverage_v332["network_contacted"],
            "input_sha256": spectron_dynamic_symbol_coverage_v332["input_sha256"],
            "summary": spectron_dynamic_symbol_coverage_v332["summary"],
        },
        {
            "artifact": "spectron_dynamic_symbol_coverage_audit_20260828",
            "network_contacted": False,
    ...
    check(
        "Spectron v332 semantic translation",
        {
            "artifact": spectron_semantic_translation_v332["artifact"],
            "network_contacted": spectron_semantic_translation_v332["network_contacted"],
            "summary": spectron_semantic_translation_v332["summary"],
            "carried_forward": spectron_semantic_translation_v332["carried_forward"]["target_feature_count"],
        },
        {
            "artifact": "spectron_semantic_function_translation",
            "network_contacted": False,
    ...
    check(
        "Spectron v332 feature export",
        {
            "artifact": spectron_features_v332["artifact"],
            "network_contacted": spectron_features_v332["network_contacted"],
            "function_count": spectron_features_v332["function_count"],
        },
        {
            "artifact": "ida_function_features",
            "network_contacted": False,
    ...
    check(
        "Spectron v332 checkpoint artifact",
        spectron_checkpoint_v332["artifact"],
        "spectron_translation_checkpoint_20260829_v332",
    )
    check(
        "Spectron v332 checkpoint parent",
        spectron_checkpoint_v332["parent_checkpoint"]["artifact"],
        "spectron_translation_checkpoint_20260829_v331",
    )
    check(
        "Spectron v332 checkpoint database",
        {
            "sha256": spectron_checkpoint_v332["database"]["sha256"],
            "close_reopen_verified": spectron_checkpoint_v332["database"]["close_reopen_verified"],
            "function_count": spectron_checkpoint_v332["database"]["function_count"],
            "default_name_count": spectron_checkpoint_v332["database"]["default_name_count"],
        },
        {
            "sha256": "f77edbe5076211bd3bd5a18c549f0c3cbaeeb88d2da7bc9c52a2733c1d87cdc2",
            "close_reopen_verified": True,
            "function_count": 11707,
            "default_name_count": 0,
        },
    ...
    check(
        "Spectron v332 TPanelOperation checkpoint",
        {
            "anchor_count": spectron_checkpoint_v332["paneloperation_residual_translation_v332"]["anchor_count"],
            "high_confidence_count": spectron_checkpoint_v332["paneloperation_residual_translation_v332"]["high_confidence_count"],
            "exact_metric_anchor_count": spectron_checkpoint_v332["paneloperation_residual_translation_v332"]["exact_metric_anchor_count"],
            "layout_change_anchor_count": spectron_checkpoint_v332["paneloperation_residual_translation_v332"]["layout_change_anchor_count"],
            "new_context_anchor_count": spectron_checkpoint_v332["paneloperation_residual_translation_v332"]["new_context_anchor_count"],
            "semantic_promotion_count": spectron_checkpoint_v332["paneloperation_residual_translation_v332"]["semantic_promotion_count"],
            "reopen_verified": spectron_checkpoint_v332["paneloperation_residual_translation_v332"]["reopen_verified"],
        },
        {
            "anchor_count": 20,
            "high_confidence_count": 20,
    ...
    check(
        "Spectron v333 THashIntVar residual anchor artifact",
        spectron_hashintvar_residual_anchors_v333["artifact"],
        "spectron_hashintvar_residual_manual_translation_anchors_20260829",
    )
    check(
        "Spectron v333 THashIntVar residual anchor network",
        spectron_hashintvar_residual_anchors_v333["network_contacted"],
        False,
    )
    check(
        "Spectron v333 THashIntVar residual anchor summary",
        spectron_hashintvar_residual_anchors_v333["summary"],
        {
            "anchor_count": 2,
            "exact_metric_anchor_count": 0,
            "high_confidence_count": 2,
    ...
    check(
        "Spectron v333 THashIntVar residual source aliases",
        [row["proposed_name"] for row in spectron_hashintvar_residual_anchors_v333["anchors"]],
        [
            "v18_THashIntVar_THashIntVar",
            "v18_THashIntVar_THashIntVar__2",
        ],
    )
    check(
        "Spectron v333 THashIntVar residual target addresses",
        [row["spectron_ea"] for row in spectron_hashintvar_residual_anchors_v333["anchors"]],
        ["0x11df60", "0x11df74"],
    )
    check(
        "Spectron v333 THashIntVar residual application counts",
        {
            "artifact": spectron_hashintvar_residual_application_v333["artifact"],
            "anchor_count": spectron_hashintvar_residual_application_v333["anchor_count"],
            "resolved_count": spectron_hashintvar_residual_application_v333["resolved_count"],
            "renamed_count": spectron_hashintvar_residual_application_v333["renamed_count"],
            "comments_added": spectron_hashintvar_residual_application_v333["comments_added"],
            "failure_count": spectron_hashintvar_residual_application_v333["failure_count"],
            "saved": spectron_hashintvar_residual_application_v333["saved"],
            "verified": spectron_hashintvar_residual_application_v333["verified"],
            "verified_name_count": spectron_hashintvar_residual_application_v333["verified_name_count"],
        },
        {
            "artifact": "spectron_manual_anchor_application",
            "anchor_count": 2,
    ...
    check(
        "Spectron v333 THashIntVar residual reopen verification",
        {
            "artifact": spectron_hashintvar_residual_verification_v333["artifact"],
            "anchor_count": spectron_hashintvar_residual_verification_v333["anchor_count"],
            "failure_count": spectron_hashintvar_residual_verification_v333["failure_count"],
            "function_count": spectron_hashintvar_residual_verification_v333["function_count"],
            "verified": spectron_hashintvar_residual_verification_v333["verified"],
            "verified_name_count": spectron_hashintvar_residual_verification_v333["verified_name_count"],
        },
        {
            "artifact": "spectron_manual_anchor_reopen_verification",
            "anchor_count": 2,
    ...
    check(
        "Spectron v333 name audit",
        {
            "artifact": spectron_name_coverage_v333["artifact"],
            "network_contacted": spectron_name_coverage_v333["network_contacted"],
            "input_sha256": spectron_name_coverage_v333["input_sha256"],
            "function_count": spectron_name_coverage_v333["function_count"],
            "default_name_count": spectron_name_coverage_v333["default_name_count"],
            "name_origins": spectron_name_coverage_v333["name_origins"],
        },
        {
            "artifact": "spectron_name_coverage_audit",
            "network_contacted": False,
            ...
            "name_origins": {
                "ida_named_or_other": 4052,
                "target_jni_export": 7,
                "target_named_export": 845,
                "target_only_descriptive": 419,
                "translated_v18_alias": 6384,
            },
        },
    )
    check(
        "Spectron v333 dynamic boundary counts",
        {
            "artifact": spectron_dynamic_boundaries_v333["artifact"],
            "network_contacted": spectron_dynamic_boundaries_v333["network_contacted"],
            "input_sha256": spectron_dynamic_boundaries_v333["input_sha256"],
            "defined_function_symbol_count": spectron_dynamic_boundaries_v333["defined_function_symbol_count"],
            "ida_exact_start_count": spectron_dynamic_boundaries_v333["ida_exact_start_count"],
            "ida_missing_exact_start_count": spectron_dynamic_boundaries_v333["ida_missing_exact_start_count"],
            "row_count": len(spectron_dynamic_boundaries_v333["rows"]),
        },
        {
            "artifact": "spectron_dynamic_symbol_boundary_audit",
            "network_contacted": False,
    ...
    check(
        "Spectron v333 dynamic symbol coverage",
        {
            "artifact": spectron_dynamic_symbol_coverage_v333["artifact"],
            "network_contacted": spectron_dynamic_symbol_coverage_v333["network_contacted"],
            "input_sha256": spectron_dynamic_symbol_coverage_v333["input_sha256"],
            "summary": spectron_dynamic_symbol_coverage_v333["summary"],
        },
        {
            "artifact": "spectron_dynamic_symbol_coverage_audit_20260828",
            "network_contacted": False,
            ...
            "summary": {
                ...
                "name_match_counts": {
                    "item_name_match": 1733,
                    "item_name_mismatch": 5037,
                    "value_name_match": 1733,
                    "value_name_mismatch": 5037,
                },
                "named_dynamic_symbol_count": 6770,
                "status_counts": {
                    "exact_retained_dynamic_name": 1733,
                    "linker_boundary_alias_mismatch": 7,
                    "other_retained_target_name": 123,
                    "source_backed_v18_alias": 4735,
                    "target_only_descriptive": 2,
                    "undefined_import_with_plt_stub": 169,
                    "undefined_no_target_address": 1,
                },
    ...
    check(
        "Spectron v333 semantic translation",
        {
            "artifact": spectron_semantic_translation_v333["artifact"],
            "network_contacted": spectron_semantic_translation_v333["network_contacted"],
            "summary": spectron_semantic_translation_v333["summary"],
            "carried_forward": spectron_semantic_translation_v333["carried_forward"]["target_feature_count"],
        },
        {
            "artifact": "spectron_semantic_function_translation",
            "network_contacted": False,
    ...
    check(
        "Spectron v333 feature export",
        {
            "artifact": spectron_features_v333["artifact"],
            "network_contacted": spectron_features_v333["network_contacted"],
            "function_count": spectron_features_v333["function_count"],
        },
        {
            "artifact": "ida_function_features",
            "network_contacted": False,
    ...
    check(
        "Spectron v333 checkpoint artifact",
        spectron_checkpoint_v333["artifact"],
        "spectron_translation_checkpoint_20260829_v333",
    )
    check(
        "Spectron v333 checkpoint parent",
        spectron_checkpoint_v333["parent_checkpoint"]["artifact"],
        "spectron_translation_checkpoint_20260829_v332",
    )
    check(
        "Spectron v333 checkpoint database",
        {
            "sha256": spectron_checkpoint_v333["database"]["sha256"],
            "close_reopen_verified": spectron_checkpoint_v333["database"]["close_reopen_verified"],
            "function_count": spectron_checkpoint_v333["database"]["function_count"],
            "default_name_count": spectron_checkpoint_v333["database"]["default_name_count"],
        },
        {
            "sha256": "c6f31412206a9a893fedf594fac90dff2f13be69f2db28fcda80cc2c67ad7f4d",
            "close_reopen_verified": True,
            "function_count": 11707,
            "default_name_count": 0,
        },
    ...
    check(
        "Spectron v333 THashIntVar checkpoint",
        {
            "anchor_count": spectron_checkpoint_v333["hashintvar_residual_translation_v333"]["anchor_count"],
            "high_confidence_count": spectron_checkpoint_v333["hashintvar_residual_translation_v333"]["high_confidence_count"],
            "exact_metric_anchor_count": spectron_checkpoint_v333["hashintvar_residual_translation_v333"]["exact_metric_anchor_count"],
            "layout_change_anchor_count": spectron_checkpoint_v333["hashintvar_residual_translation_v333"]["layout_change_anchor_count"],
            "new_context_anchor_count": spectron_checkpoint_v333["hashintvar_residual_translation_v333"]["new_context_anchor_count"],
            "semantic_promotion_count": spectron_checkpoint_v333["hashintvar_residual_translation_v333"]["semantic_promotion_count"],
            "reopen_verified": spectron_checkpoint_v333["hashintvar_residual_translation_v333"]["reopen_verified"],
        },
        {
            "anchor_count": 2,
            "high_confidence_count": 2,
    ...
    check(
        "Spectron v334 bitmap JPEG static anchor artifact",
        spectron_bitmap_jpeg_static_anchors_v334["artifact"],
        "spectron_bitmap_jpeg_static_manual_translation_anchors_20260829",
    )
    check(
        "Spectron v334 bitmap JPEG static anchor network",
        spectron_bitmap_jpeg_static_anchors_v334["network_contacted"],
        False,
    )
    check(
        "Spectron v334 bitmap JPEG static anchor summary",
        spectron_bitmap_jpeg_static_anchors_v334["summary"],
        {
            "anchor_count": 1,
            "exact_metric_anchor_count": 0,
            ...
            "new_context_anchor_count": 1,
            "semantic_promotion_count": 0,
            "source_pseudocode_count": 1,
            "target_pseudocode_count": 1,
        },
    )
    check(
        "Spectron v334 bitmap JPEG static source aliases",
        [row["proposed_name"] for row in spectron_bitmap_jpeg_static_anchors_v334["anchors"]],
        ["v18_TBitmap_jpeg_initStaticScriptVars_void"],
    )
    check(
        "Spectron v334 bitmap JPEG static target addresses",
        [row["spectron_ea"] for row in spectron_bitmap_jpeg_static_anchors_v334["anchors"]],
        ["0x1541bc"],
    )
    check(
        "Spectron v334 bitmap JPEG static application counts",
        {
            "artifact": spectron_bitmap_jpeg_static_application_v334["artifact"],
            "anchor_count": spectron_bitmap_jpeg_static_application_v334["anchor_count"],
            "resolved_count": spectron_bitmap_jpeg_static_application_v334["resolved_count"],
            "renamed_count": spectron_bitmap_jpeg_static_application_v334["renamed_count"],
            "comments_added": spectron_bitmap_jpeg_static_application_v334["comments_added"],
            "failure_count": spectron_bitmap_jpeg_static_application_v334["failure_count"],
            "saved": spectron_bitmap_jpeg_static_application_v334["saved"],
            "verified": spectron_bitmap_jpeg_static_application_v334["verified"],
            "verified_name_count": spectron_bitmap_jpeg_static_application_v334["verified_name_count"],
        },
        {
            "artifact": "spectron_manual_anchor_application",
            "anchor_count": 1,
    ...
    check(
        "Spectron v334 bitmap JPEG static reopen verification",
        {
            "artifact": spectron_bitmap_jpeg_static_verification_v334["artifact"],
            "anchor_count": spectron_bitmap_jpeg_static_verification_v334["anchor_count"],
            "failure_count": spectron_bitmap_jpeg_static_verification_v334["failure_count"],
            "function_count": spectron_bitmap_jpeg_static_verification_v334["function_count"],
            "verified": spectron_bitmap_jpeg_static_verification_v334["verified"],
            "verified_name_count": spectron_bitmap_jpeg_static_verification_v334["verified_name_count"],
        },
        {
            "artifact": "spectron_manual_anchor_reopen_verification",
            "anchor_count": 1,
    ...
    check(
        "Spectron v334 name audit",
        {
            "artifact": spectron_name_coverage_v334["artifact"],
            "network_contacted": spectron_name_coverage_v334["network_contacted"],
            "input_sha256": spectron_name_coverage_v334["input_sha256"],
            "function_count": spectron_name_coverage_v334["function_count"],
            "default_name_count": spectron_name_coverage_v334["default_name_count"],
            "name_origins": spectron_name_coverage_v334["name_origins"],
        },
        {
            "artifact": "spectron_name_coverage_audit",
            "network_contacted": False,
            ...
            "name_origins": {
                "ida_named_or_other": 4052,
                "target_jni_export": 7,
                "target_named_export": 844,
                "target_only_descriptive": 419,
                "translated_v18_alias": 6385,
            },
        },
    )
    check(
        "Spectron v334 dynamic boundary counts",
        {
            "artifact": spectron_dynamic_boundaries_v334["artifact"],
            "network_contacted": spectron_dynamic_boundaries_v334["network_contacted"],
            "input_sha256": spectron_dynamic_boundaries_v334["input_sha256"],
            "defined_function_symbol_count": spectron_dynamic_boundaries_v334["defined_function_symbol_count"],
            "ida_exact_start_count": spectron_dynamic_boundaries_v334["ida_exact_start_count"],
            "ida_missing_exact_start_count": spectron_dynamic_boundaries_v334["ida_missing_exact_start_count"],
            "row_count": len(spectron_dynamic_boundaries_v334["rows"]),
        },
        {
            "artifact": "spectron_dynamic_symbol_boundary_audit",
            "network_contacted": False,
    ...
    check(
        "Spectron v334 dynamic symbol coverage",
        {
            "artifact": spectron_dynamic_symbol_coverage_v334["artifact"],
            "network_contacted": spectron_dynamic_symbol_coverage_v334["network_contacted"],
            "input_sha256": spectron_dynamic_symbol_coverage_v334["input_sha256"],
            "summary": spectron_dynamic_symbol_coverage_v334["summary"],
        },
        {
            "artifact": "spectron_dynamic_symbol_coverage_audit_20260828",
            "network_contacted": False,
            ...
            "summary": {
                ...
                "name_match_counts": {
                    "item_name_match": 1732,
                    "item_name_mismatch": 5038,
                    "value_name_match": 1732,
                    "value_name_mismatch": 5038,
                },
                "named_dynamic_symbol_count": 6770,
                "status_counts": {
                    "exact_retained_dynamic_name": 1732,
                    "linker_boundary_alias_mismatch": 7,
                    "other_retained_target_name": 123,
                    "source_backed_v18_alias": 4736,
                    "target_only_descriptive": 2,
                    "undefined_import_with_plt_stub": 169,
                    "undefined_no_target_address": 1,
                },
    ...
    check(
        "Spectron v334 semantic translation",
        {
            "artifact": spectron_semantic_translation_v334["artifact"],
            "network_contacted": spectron_semantic_translation_v334["network_contacted"],
            "summary": spectron_semantic_translation_v334["summary"],
            "carried_forward": spectron_semantic_translation_v334["carried_forward"]["target_feature_count"],
        },
        {
            "artifact": "spectron_semantic_function_translation",
            "network_contacted": False,
    ...
    check(
        "Spectron v334 feature export",
        {
            "artifact": spectron_features_v334["artifact"],
            "network_contacted": spectron_features_v334["network_contacted"],
            "function_count": spectron_features_v334["function_count"],
        },
        {
            "artifact": "ida_function_features",
            "network_contacted": False,
    ...
    check(
        "Spectron v334 checkpoint artifact",
        spectron_checkpoint_v334["artifact"],
        "spectron_translation_checkpoint_20260829_v334",
    )
    check(
        "Spectron v334 checkpoint parent",
        spectron_checkpoint_v334["parent_checkpoint"]["artifact"],
        "spectron_translation_checkpoint_20260829_v333",
    )
    check(
        "Spectron v334 checkpoint database",
        {
            "sha256": spectron_checkpoint_v334["database"]["sha256"],
            "close_reopen_verified": spectron_checkpoint_v334["database"]["close_reopen_verified"],
            "function_count": spectron_checkpoint_v334["database"]["function_count"],
            "default_name_count": spectron_checkpoint_v334["database"]["default_name_count"],
        },
        {
            "sha256": "c2002066a0412b180afd6abb36fe08f0873403d3068a2a0bdd88deb997101398",
            "close_reopen_verified": True,
            "function_count": 11707,
            "default_name_count": 0,
        },
    ...
    check(
        "Spectron v334 bitmap JPEG static checkpoint",
        {
            "anchor_count": spectron_checkpoint_v334["bitmap_jpeg_static_translation_v334"]["anchor_count"],
            "high_confidence_count": spectron_checkpoint_v334["bitmap_jpeg_static_translation_v334"]["high_confidence_count"],
            "exact_metric_anchor_count": spectron_checkpoint_v334["bitmap_jpeg_static_translation_v334"]["exact_metric_anchor_count"],
            "layout_change_anchor_count": spectron_checkpoint_v334["bitmap_jpeg_static_translation_v334"]["layout_change_anchor_count"],
            "new_context_anchor_count": spectron_checkpoint_v334["bitmap_jpeg_static_translation_v334"]["new_context_anchor_count"],
            "semantic_promotion_count": spectron_checkpoint_v334["bitmap_jpeg_static_translation_v334"]["semantic_promotion_count"],
            "reopen_verified": spectron_checkpoint_v334["bitmap_jpeg_static_translation_v334"]["reopen_verified"],
        },
        {
            "anchor_count": 1,
            "high_confidence_count": 1,
    ...
    check(
        "Spectron v335 Adventure residual anchor artifact",
        spectron_adventure_static_residual_anchors_v335["artifact"],
        "spectron_adventure_static_residual_manual_translation_anchors_20260829",
    )
    check(
        "Spectron v335 Adventure residual anchor network",
        spectron_adventure_static_residual_anchors_v335["network_contacted"],
        False,
    )
    check(
        "Spectron v335 Adventure residual anchor summary",
        spectron_adventure_static_residual_anchors_v335["summary"],
        {
            "anchor_count": 4,
            "exact_metric_anchor_count": 3,
            "high_confidence_count": 4,
            "layout_change_anchor_count": 1,
            "new_context_anchor_count": 4,
            "semantic_promotion_count": 0,
            "source_pseudocode_count": 4,
            "target_pseudocode_count": 4,
        },
    )
    check(
        "Spectron v335 Adventure residual aliases",
        [row["proposed_name"] for row in spectron_adventure_static_residual_anchors_v335["anchors"]],
        [
            "v18_gsfunctions_client_initStaticVars_void",
            "v18_TAdventure_freeResources_void",
            "v18_TAdventure_handleMouseMove_void",
            "v18_TAdventure_initStaticScriptVars_void",
        ],
    )
    check(
        "Spectron v335 Adventure residual target addresses",
        [row["spectron_ea"] for row in spectron_adventure_static_residual_anchors_v335["anchors"]],
        ["0x15de64", "0x15e528", "0x15ef90", "0x15f27c"],
    )
    check(
        "Spectron v335 Adventure residual application counts",
        {
            "artifact": spectron_adventure_static_residual_application_v335["artifact"],
            "anchor_count": spectron_adventure_static_residual_application_v335["anchor_count"],
            "resolved_count": spectron_adventure_static_residual_application_v335["resolved_count"],
            "renamed_count": spectron_adventure_static_residual_application_v335["renamed_count"],
            "comments_added": spectron_adventure_static_residual_application_v335["comments_added"],
            "failure_count": spectron_adventure_static_residual_application_v335["failure_count"],
            "saved": spectron_adventure_static_residual_application_v335["saved"],
            "verified": spectron_adventure_static_residual_application_v335["verified"],
            "verified_name_count": spectron_adventure_static_residual_application_v335["verified_name_count"],
        },
        {
            "artifact": "spectron_manual_anchor_application",
            "anchor_count": 4,
            ...
            "saved": True,
            "verified": True,
            "verified_name_count": 4,
        },
    )
    check(
        "Spectron v335 Adventure residual reopen verification",
        {
            "artifact": spectron_adventure_static_residual_verification_v335["artifact"],
            "anchor_count": spectron_adventure_static_residual_verification_v335["anchor_count"],
            "failure_count": spectron_adventure_static_residual_verification_v335["failure_count"],
            "function_count": spectron_adventure_static_residual_verification_v335["function_count"],
            "verified": spectron_adventure_static_residual_verification_v335["verified"],
            "verified_name_count": spectron_adventure_static_residual_verification_v335["verified_name_count"],
        },
        {
            "artifact": "spectron_manual_anchor_reopen_verification",
            "anchor_count": 4,
    ...
    check(
        "Spectron v335 name audit",
        {
            "artifact": spectron_name_coverage_v335["artifact"],
            "network_contacted": spectron_name_coverage_v335["network_contacted"],
            "input_sha256": spectron_name_coverage_v335["input_sha256"],
            "function_count": spectron_name_coverage_v335["function_count"],
            "default_name_count": spectron_name_coverage_v335["default_name_count"],
            "name_origins": spectron_name_coverage_v335["name_origins"],
        },
        {
            "artifact": "spectron_name_coverage_audit",
            "network_contacted": False,
            ...
            "name_origins": {
                "ida_named_or_other": 4052,
                "target_jni_export": 7,
                "target_named_export": 840,
                "target_only_descriptive": 419,
                "translated_v18_alias": 6389,
            },
        },
    )
    check(
        "Spectron v335 dynamic boundary counts",
        {
            "artifact": spectron_dynamic_boundaries_v335["artifact"],
            "network_contacted": spectron_dynamic_boundaries_v335["network_contacted"],
            "input_sha256": spectron_dynamic_boundaries_v335["input_sha256"],
            "defined_function_symbol_count": spectron_dynamic_boundaries_v335["defined_function_symbol_count"],
            "ida_exact_start_count": spectron_dynamic_boundaries_v335["ida_exact_start_count"],
            "ida_missing_exact_start_count": spectron_dynamic_boundaries_v335["ida_missing_exact_start_count"],
            "row_count": len(spectron_dynamic_boundaries_v335["rows"]),
        },
        {
            "artifact": "spectron_dynamic_symbol_boundary_audit",
            "network_contacted": False,
    ...
    check(
        "Spectron v335 dynamic symbol coverage",
        {
            "artifact": spectron_dynamic_symbol_coverage_v335["artifact"],
            "network_contacted": spectron_dynamic_symbol_coverage_v335["network_contacted"],
            "input_sha256": spectron_dynamic_symbol_coverage_v335["input_sha256"],
            "summary": spectron_dynamic_symbol_coverage_v335["summary"],
        },
        {
            "artifact": "spectron_dynamic_symbol_coverage_audit_20260828",
            "network_contacted": False,
            ...
            "summary": {
                ...
                "name_match_counts": {
                    "item_name_match": 1728,
                    "item_name_mismatch": 5042,
                    "value_name_match": 1728,
                    "value_name_mismatch": 5042,
                },
                "named_dynamic_symbol_count": 6770,
                "status_counts": {
                    "exact_retained_dynamic_name": 1728,
                    "linker_boundary_alias_mismatch": 7,
                    "other_retained_target_name": 123,
                    "source_backed_v18_alias": 4740,
                    "target_only_descriptive": 2,
                    "undefined_import_with_plt_stub": 169,
                    "undefined_no_target_address": 1,
                },
    ...
    check(
        "Spectron v335 semantic translation",
        {
            "artifact": spectron_semantic_translation_v335["artifact"],
            "network_contacted": spectron_semantic_translation_v335["network_contacted"],
            "summary": spectron_semantic_translation_v335["summary"],
            "carried_forward": spectron_semantic_translation_v335["carried_forward"]["target_feature_count"],
        },
        {
            "artifact": "spectron_semantic_function_translation",
            "network_contacted": False,
    ...
    check(
        "Spectron v335 feature export",
        {
            "artifact": spectron_features_v335["artifact"],
            "network_contacted": spectron_features_v335["network_contacted"],
            "function_count": spectron_features_v335["function_count"],
        },
        {
            "artifact": "ida_function_features",
            "network_contacted": False,
    ...
    check(
        "Spectron v335 checkpoint artifact",
        spectron_checkpoint_v335["artifact"],
        "spectron_translation_checkpoint_20260829_v335",
    )
    check(
        "Spectron v335 checkpoint parent",
        spectron_checkpoint_v335["parent_checkpoint"]["artifact"],
        "spectron_translation_checkpoint_20260829_v334",
    )
    check(
        "Spectron v335 checkpoint database",
        {
            "sha256": spectron_checkpoint_v335["database"]["sha256"],
            "close_reopen_verified": spectron_checkpoint_v335["database"]["close_reopen_verified"],
            "function_count": spectron_checkpoint_v335["database"]["function_count"],
            "default_name_count": spectron_checkpoint_v335["database"]["default_name_count"],
        },
        {
            "sha256": "dae970eb4edf7237544073da7badb3cfe0bd9d3ccb03e8ec9bde5b5c7de73a16",
            "close_reopen_verified": True,
            "function_count": 11707,
            "default_name_count": 0,
        },
    ...
    check(
        "Spectron v335 Adventure residual checkpoint",
        {
            "anchor_count": spectron_checkpoint_v335["adventure_static_residual_translation_v335"]["anchor_count"],
            "high_confidence_count": spectron_checkpoint_v335["adventure_static_residual_translation_v335"]["high_confidence_count"],
            "exact_metric_anchor_count": spectron_checkpoint_v335["adventure_static_residual_translation_v335"]["exact_metric_anchor_count"],
            "layout_change_anchor_count": spectron_checkpoint_v335["adventure_static_residual_translation_v335"]["layout_change_anchor_count"],
            "new_context_anchor_count": spectron_checkpoint_v335["adventure_static_residual_translation_v335"]["new_context_anchor_count"],
            "semantic_promotion_count": spectron_checkpoint_v335["adventure_static_residual_translation_v335"]["semantic_promotion_count"],
            "reopen_verified": spectron_checkpoint_v335["adventure_static_residual_translation_v335"]["reopen_verified"],
        },
        {
            "anchor_count": 4,
            "high_confidence_count": 4,
    ...
    check(
        "Spectron v336 Format2 residual anchor artifact",
        spectron_format2_residual_anchors_v336["artifact"],
        "spectron_format2_residual_manual_translation_anchors_20260829",
    )
    check(
        "Spectron v336 Format2 residual anchor network",
        spectron_format2_residual_anchors_v336["network_contacted"],
        False,
    )
    check(
        "Spectron v336 Format2 residual anchor summary",
        spectron_format2_residual_anchors_v336["summary"],
        {
            "anchor_count": 9,
            "exact_metric_anchor_count": 4,
    ...
    check(
        "Spectron v336 Format2 residual aliases",
        [row["proposed_name"] for row in spectron_format2_residual_anchors_v336["anchors"]],
        [
    ...
    check(
        "Spectron v336 Format2 residual target addresses",
        [row["spectron_ea"] for row in spectron_format2_residual_anchors_v336["anchors"]],
        [
            "0x2130b0",
            "0x213218",
            "0x2132a0",
    ...
    check(
        "Spectron v336 Format2 residual application counts",
        {
            "artifact": spectron_format2_residual_application_v336["artifact"],
            "anchor_count": spectron_format2_residual_application_v336["anchor_count"],
            "resolved_count": spectron_format2_residual_application_v336["resolved_count"],
            "renamed_count": spectron_format2_residual_application_v336["renamed_count"],
            "comments_added": spectron_format2_residual_application_v336["comments_added"],
            "failure_count": spectron_format2_residual_application_v336["failure_count"],
            "saved": spectron_format2_residual_application_v336["saved"],
            "verified": spectron_format2_residual_application_v336["verified"],
            "verified_name_count": spectron_format2_residual_application_v336["verified_name_count"],
        },
        {
            "artifact": "spectron_manual_anchor_application",
            "anchor_count": 9,
            ...
            "saved": True,
            "verified": True,
            "verified_name_count": 9,
        },
    )
    check(
        "Spectron v336 Format2 residual reopen verification",
        {
            "artifact": spectron_format2_residual_verification_v336["artifact"],
            "anchor_count": spectron_format2_residual_verification_v336["anchor_count"],
            "failure_count": spectron_format2_residual_verification_v336["failure_count"],
            "function_count": spectron_format2_residual_verification_v336["function_count"],
            "verified": spectron_format2_residual_verification_v336["verified"],
            "verified_name_count": spectron_format2_residual_verification_v336["verified_name_count"],
        },
        {
            "artifact": "spectron_manual_anchor_reopen_verification",
            "anchor_count": 9,
    ...
    check(
        "Spectron v336 name audit",
        {
            "artifact": spectron_name_coverage_v336["artifact"],
            "network_contacted": spectron_name_coverage_v336["network_contacted"],
            "input_sha256": spectron_name_coverage_v336["input_sha256"],
            "function_count": spectron_name_coverage_v336["function_count"],
            "default_name_count": spectron_name_coverage_v336["default_name_count"],
            "name_origins": spectron_name_coverage_v336["name_origins"],
        },
        {
            "artifact": "spectron_name_coverage_audit",
            "network_contacted": False,
    ...
    check(
        "Spectron v336 dynamic boundary counts",
        {
            "artifact": spectron_dynamic_boundaries_v336["artifact"],
            "network_contacted": spectron_dynamic_boundaries_v336["network_contacted"],
            "input_sha256": spectron_dynamic_boundaries_v336["input_sha256"],
            "defined_function_symbol_count": spectron_dynamic_boundaries_v336["defined_function_symbol_count"],
            "ida_exact_start_count": spectron_dynamic_boundaries_v336["ida_exact_start_count"],
            "ida_missing_exact_start_count": spectron_dynamic_boundaries_v336["ida_missing_exact_start_count"],
            "row_count": len(spectron_dynamic_boundaries_v336["rows"]),
        },
        {
            "artifact": "spectron_dynamic_symbol_boundary_audit",
            "network_contacted": False,
    ...
    check(
        "Spectron v336 dynamic symbol coverage",
        {
            "artifact": spectron_dynamic_symbol_coverage_v336["artifact"],
            "network_contacted": spectron_dynamic_symbol_coverage_v336["network_contacted"],
            "input_sha256": spectron_dynamic_symbol_coverage_v336["input_sha256"],
            "summary": spectron_dynamic_symbol_coverage_v336["summary"],
        },
        {
            "artifact": "spectron_dynamic_symbol_coverage_audit_20260828",
            "network_contacted": False,
    ...
    check(
        "Spectron v336 semantic translation",
        {
            "artifact": spectron_semantic_translation_v336["artifact"],
            "network_contacted": spectron_semantic_translation_v336["network_contacted"],
            "summary": spectron_semantic_translation_v336["summary"],
            "carried_forward": spectron_semantic_translation_v336["carried_forward"]["target_feature_count"],
        },
        {
            "artifact": "spectron_semantic_function_translation",
            "network_contacted": False,
    ...
    check(
        "Spectron v336 feature export",
        {
            "artifact": spectron_features_v336["artifact"],
            "network_contacted": spectron_features_v336["network_contacted"],
            "function_count": spectron_features_v336["function_count"],
        },
        {
            "artifact": "ida_function_features",
            "network_contacted": False,
    ...
    check(
        "Spectron v336 checkpoint artifact",
        spectron_checkpoint_v336["artifact"],
        "spectron_translation_checkpoint_20260829_v336",
    )
    check(
        "Spectron v336 checkpoint parent",
        spectron_checkpoint_v336["parent_checkpoint"]["artifact"],
        "spectron_translation_checkpoint_20260829_v335",
    )
    check(
        "Spectron v336 checkpoint database",
        {
            "sha256": spectron_checkpoint_v336["database"]["sha256"],
            "close_reopen_verified": spectron_checkpoint_v336["database"]["close_reopen_verified"],
            "function_count": spectron_checkpoint_v336["database"]["function_count"],
            "default_name_count": spectron_checkpoint_v336["database"]["default_name_count"],
        },
        {
            "sha256": "55662a1b9e5989c1e14350ab585015ccb6af0af123f12fab0dcab414f54ca199",
            "close_reopen_verified": True,
            "function_count": 11707,
            "default_name_count": 0,
        },
    ...
    check(
        "Spectron v336 Format2 residual checkpoint",
        {
            "anchor_count": spectron_checkpoint_v336["format2_residual_translation_v336"]["anchor_count"],
            "high_confidence_count": spectron_checkpoint_v336["format2_residual_translation_v336"]["high_confidence_count"],
            "exact_metric_anchor_count": spectron_checkpoint_v336["format2_residual_translation_v336"]["exact_metric_anchor_count"],
            "layout_change_anchor_count": spectron_checkpoint_v336["format2_residual_translation_v336"]["layout_change_anchor_count"],
            "new_context_anchor_count": spectron_checkpoint_v336["format2_residual_translation_v336"]["new_context_anchor_count"],
            "semantic_promotion_count": spectron_checkpoint_v336["format2_residual_translation_v336"]["semantic_promotion_count"],
            "reopen_verified": spectron_checkpoint_v336["format2_residual_translation_v336"]["reopen_verified"],
        },
        {
            "anchor_count": 9,
            "high_confidence_count": 9,
    ...
    check(
        "Spectron v337 libjpeg helper residual anchor artifact",
        spectron_libjpeg_helper_residual_anchors_v337["artifact"],
        "spectron_libjpeg_helper_residual_manual_translation_anchors_20260829",
    )
    check(
        "Spectron v337 libjpeg helper residual anchor network",
        spectron_libjpeg_helper_residual_anchors_v337["network_contacted"],
        False,
    )
    check(
        "Spectron v337 libjpeg helper residual anchor summary",
        spectron_libjpeg_helper_residual_anchors_v337["summary"],
        {
            "anchor_count": 12,
            "exact_metric_anchor_count": 12,
            "high_confidence_count": 12,
    ...
    check(
        "Spectron v337 libjpeg helper residual aliases",
        [row["proposed_name"] for row in spectron_libjpeg_helper_residual_anchors_v337["anchors"]],
        [
            "v18_jpeg_get_small_jpeg_common_struct_ulong",
            "v18_jpeg_free_small_jpeg_common_struct_void_ulong",
            "v18_jpeg_get_large_jpeg_common_struct_ulong",
            "v18_jpeg_free_large_jpeg_common_struct_void_ulong",
            "v18_jpeg_mem_available_jpeg_common_struct_long_long_long",
            "v18_jpeg_open_backing_store_jpeg_common_struct_backing_store_struct_long",
            "v18_jpeg_mem_init_jpeg_common_struct",
            "v18_jpeg_mem_term_jpeg_common_struct",
            "v18_jdiv_round_up_long_long",
            "v18_jround_up_long_long",
            "v18_jcopy_block_row_short_64_short_64_uint",
            "v18_jzero_far_void_ulong",
        ],
    )
    check(
        "Spectron v337 libjpeg helper residual target addresses",
        [row["spectron_ea"] for row in spectron_libjpeg_helper_residual_anchors_v337["anchors"]],
        [
            "0x2a2358",
            "0x2a2360",
            "0x2a2368",
    ...
    check(
        "Spectron v337 libjpeg helper residual application counts",
        {
            "artifact": spectron_libjpeg_helper_residual_application_v337["artifact"],
            "anchor_count": spectron_libjpeg_helper_residual_application_v337["anchor_count"],
            "resolved_count": spectron_libjpeg_helper_residual_application_v337["resolved_count"],
            "renamed_count": spectron_libjpeg_helper_residual_application_v337["renamed_count"],
            "comments_added": spectron_libjpeg_helper_residual_application_v337["comments_added"],
            "failure_count": spectron_libjpeg_helper_residual_application_v337["failure_count"],
            "saved": spectron_libjpeg_helper_residual_application_v337["saved"],
            "verified": spectron_libjpeg_helper_residual_application_v337["verified"],
            "verified_name_count": spectron_libjpeg_helper_residual_application_v337["verified_name_count"],
        },
        {
            "artifact": "spectron_manual_anchor_application",
            "anchor_count": 12,
    ...
    check(
        "Spectron v337 libjpeg helper residual reopen verification",
        {
            "artifact": spectron_libjpeg_helper_residual_verification_v337["artifact"],
            "anchor_count": spectron_libjpeg_helper_residual_verification_v337["anchor_count"],
            "failure_count": spectron_libjpeg_helper_residual_verification_v337["failure_count"],
            "function_count": spectron_libjpeg_helper_residual_verification_v337["function_count"],
            "verified": spectron_libjpeg_helper_residual_verification_v337["verified"],
            "verified_name_count": spectron_libjpeg_helper_residual_verification_v337["verified_name_count"],
        },
        {
            "artifact": "spectron_manual_anchor_reopen_verification",
            "anchor_count": 12,
    ...
    check(
        "Spectron v337 name audit",
        {
            "artifact": spectron_name_coverage_v337["artifact"],
            "network_contacted": spectron_name_coverage_v337["network_contacted"],
            "input_sha256": spectron_name_coverage_v337["input_sha256"],
            "function_count": spectron_name_coverage_v337["function_count"],
            "default_name_count": spectron_name_coverage_v337["default_name_count"],
            "name_origins": spectron_name_coverage_v337["name_origins"],
        },
        {
            "artifact": "spectron_name_coverage_audit",
            "network_contacted": False,
            ...
            "name_origins": {
                "ida_named_or_other": 4052,
                "target_jni_export": 7,
                "target_named_export": 819,
                "target_only_descriptive": 419,
                "translated_v18_alias": 6410,
            },
        },
    )
    check(
        "Spectron v337 dynamic boundary counts",
        {
            "artifact": spectron_dynamic_boundaries_v337["artifact"],
            "network_contacted": spectron_dynamic_boundaries_v337["network_contacted"],
            "input_sha256": spectron_dynamic_boundaries_v337["input_sha256"],
            "defined_function_symbol_count": spectron_dynamic_boundaries_v337["defined_function_symbol_count"],
            "ida_exact_start_count": spectron_dynamic_boundaries_v337["ida_exact_start_count"],
            "ida_missing_exact_start_count": spectron_dynamic_boundaries_v337["ida_missing_exact_start_count"],
            "row_count": len(spectron_dynamic_boundaries_v337["rows"]),
        },
        {
            "artifact": "spectron_dynamic_symbol_boundary_audit",
            "network_contacted": False,
    ...
    check(
        "Spectron v337 dynamic symbol coverage",
        {
            "artifact": spectron_dynamic_symbol_coverage_v337["artifact"],
            "network_contacted": spectron_dynamic_symbol_coverage_v337["network_contacted"],
            "input_sha256": spectron_dynamic_symbol_coverage_v337["input_sha256"],
            "summary": spectron_dynamic_symbol_coverage_v337["summary"],
        },
        {
            "artifact": "spectron_dynamic_symbol_coverage_audit_20260828",
            "network_contacted": False,
            ...
            "summary": {
                ...
                "name_match_counts": {
                    "item_name_match": 1707,
                    "item_name_mismatch": 5063,
                    "value_name_match": 1707,
                    "value_name_mismatch": 5063,
                },
                "named_dynamic_symbol_count": 6770,
                "status_counts": {
                    "exact_retained_dynamic_name": 1707,
                    "linker_boundary_alias_mismatch": 7,
                    "other_retained_target_name": 122,
                    "source_backed_v18_alias": 4762,
                    "target_only_descriptive": 2,
                    "undefined_import_with_plt_stub": 169,
                    "undefined_no_target_address": 1,
                },
    ...
    check(
        "Spectron v337 semantic translation",
        {
            "artifact": spectron_semantic_translation_v337["artifact"],
            "network_contacted": spectron_semantic_translation_v337["network_contacted"],
            "summary": spectron_semantic_translation_v337["summary"],
            "carried_forward": spectron_semantic_translation_v337["carried_forward"]["target_feature_count"],
        },
        {
            "artifact": "spectron_semantic_function_translation",
            "network_contacted": False,
    ...
    check(
        "Spectron v337 feature export",
        {
            "artifact": spectron_features_v337["artifact"],
            "network_contacted": spectron_features_v337["network_contacted"],
            "function_count": spectron_features_v337["function_count"],
        },
        {
            "artifact": "ida_function_features",
            "network_contacted": False,
    ...
    check(
        "Spectron v337 checkpoint artifact",
        spectron_checkpoint_v337["artifact"],
        "spectron_translation_checkpoint_20260829_v337",
    )
    check(
        "Spectron v337 checkpoint parent",
        spectron_checkpoint_v337["parent_checkpoint"]["artifact"],
        "spectron_translation_checkpoint_20260829_v336",
    )
    check(
        "Spectron v337 checkpoint database",
        {
            "sha256": spectron_checkpoint_v337["database"]["sha256"],
            "close_reopen_verified": spectron_checkpoint_v337["database"]["close_reopen_verified"],
            "function_count": spectron_checkpoint_v337["database"]["function_count"],
            "default_name_count": spectron_checkpoint_v337["database"]["default_name_count"],
        },
        {
            "sha256": "391d3bb01245f636760daeb8cef80012e602dfc04423d104a44ceb8e1e4d7113",
            "close_reopen_verified": True,
            "function_count": 11707,
            "default_name_count": 0,
        },
    ...
    check(
        "Spectron v337 libjpeg helper residual checkpoint",
        {
            "anchor_count": spectron_checkpoint_v337["libjpeg_helper_residual_translation_v337"]["anchor_count"],
            "high_confidence_count": spectron_checkpoint_v337["libjpeg_helper_residual_translation_v337"]["high_confidence_count"],
            "exact_metric_anchor_count": spectron_checkpoint_v337["libjpeg_helper_residual_translation_v337"]["exact_metric_anchor_count"],
            "layout_change_anchor_count": spectron_checkpoint_v337["libjpeg_helper_residual_translation_v337"]["layout_change_anchor_count"],
            "new_context_anchor_count": spectron_checkpoint_v337["libjpeg_helper_residual_translation_v337"]["new_context_anchor_count"],
            "semantic_promotion_count": spectron_checkpoint_v337["libjpeg_helper_residual_translation_v337"]["semantic_promotion_count"],
            "reopen_verified": spectron_checkpoint_v337["libjpeg_helper_residual_translation_v337"]["reopen_verified"],
        },
        {
            "anchor_count": 12,
            "high_confidence_count": 12,
    ...
    check(
        "Spectron v338 HTML-page lifecycle anchor artifact",
        spectron_html_page_lifecycle_anchors_v338["artifact"],
        "spectron_html_page_lifecycle_manual_translation_anchors_20260829",
    )
    check(
        "Spectron v338 HTML-page lifecycle anchor network",
        spectron_html_page_lifecycle_anchors_v338["network_contacted"],
        False,
    )
    check(
        "Spectron v338 HTML-page lifecycle anchor summary",
        spectron_html_page_lifecycle_anchors_v338["summary"],
        {
            "anchor_count": 7,
    ...
    check(
        "Spectron v338 HTML-page lifecycle aliases",
        [row["proposed_name"] for row in spectron_html_page_lifecycle_anchors_v338["anchors"]],
        [
    ...
    check(
        "Spectron v338 HTML-page lifecycle target addresses",
        [row["spectron_ea"] for row in spectron_html_page_lifecycle_anchors_v338["anchors"]],
        ["0x1d5f6c", "0x1d606c", "0x1d6104", "0x1d614c", "0x1d62f0", "0x1d73c0", "0x1d7724"],
    )
    check(
        "Spectron v338 HTML-page lifecycle application counts",
        {
            "artifact": spectron_html_page_lifecycle_application_v338["artifact"],
            "anchor_count": spectron_html_page_lifecycle_application_v338["anchor_count"],
            "resolved_count": spectron_html_page_lifecycle_application_v338["resolved_count"],
            "renamed_count": spectron_html_page_lifecycle_application_v338["renamed_count"],
            "comments_added": spectron_html_page_lifecycle_application_v338["comments_added"],
            "failure_count": spectron_html_page_lifecycle_application_v338["failure_count"],
            "saved": spectron_html_page_lifecycle_application_v338["saved"],
            "verified": spectron_html_page_lifecycle_application_v338["verified"],
            "verified_name_count": spectron_html_page_lifecycle_application_v338["verified_name_count"],
        },
        {
            "artifact": "spectron_manual_anchor_application",
            "anchor_count": 7,
            ...
            "saved": True,
            "verified": True,
            "verified_name_count": 7,
        },
    )
    check(
        "Spectron v338 HTML-page lifecycle reopen verification",
        {
            "artifact": spectron_html_page_lifecycle_verification_v338["artifact"],
            "anchor_count": spectron_html_page_lifecycle_verification_v338["anchor_count"],
            "failure_count": spectron_html_page_lifecycle_verification_v338["failure_count"],
            "function_count": spectron_html_page_lifecycle_verification_v338["function_count"],
            "verified": spectron_html_page_lifecycle_verification_v338["verified"],
            "verified_name_count": spectron_html_page_lifecycle_verification_v338["verified_name_count"],
        },
        {
            "artifact": "spectron_manual_anchor_reopen_verification",
            "anchor_count": 7,
    ...
    check(
        "Spectron v338 name audit",
        {
            "artifact": spectron_name_coverage_v338["artifact"],
            "network_contacted": spectron_name_coverage_v338["network_contacted"],
            "input_sha256": spectron_name_coverage_v338["input_sha256"],
            "function_count": spectron_name_coverage_v338["function_count"],
            "default_name_count": spectron_name_coverage_v338["default_name_count"],
            "name_origins": spectron_name_coverage_v338["name_origins"],
        },
        {
            "artifact": "spectron_name_coverage_audit",
            "network_contacted": False,
    ...
    check(
        "Spectron v338 dynamic boundary counts",
        {
            "artifact": spectron_dynamic_boundaries_v338["artifact"],
            "network_contacted": spectron_dynamic_boundaries_v338["network_contacted"],
            "input_sha256": spectron_dynamic_boundaries_v338["input_sha256"],
            "defined_function_symbol_count": spectron_dynamic_boundaries_v338["defined_function_symbol_count"],
            "ida_exact_start_count": spectron_dynamic_boundaries_v338["ida_exact_start_count"],
            "ida_missing_exact_start_count": spectron_dynamic_boundaries_v338["ida_missing_exact_start_count"],
            "row_count": len(spectron_dynamic_boundaries_v338["rows"]),
        },
        {
            "artifact": "spectron_dynamic_symbol_boundary_audit",
            "network_contacted": False,
    ...
    check(
        "Spectron v338 dynamic symbol coverage",
        {
            "artifact": spectron_dynamic_symbol_coverage_v338["artifact"],
            "network_contacted": spectron_dynamic_symbol_coverage_v338["network_contacted"],
            "input_sha256": spectron_dynamic_symbol_coverage_v338["input_sha256"],
            "summary": spectron_dynamic_symbol_coverage_v338["summary"],
        },
        {
            "artifact": "spectron_dynamic_symbol_coverage_audit_20260828",
            "network_contacted": False,
    ...
    check(
        "Spectron v338 semantic translation",
        {
            "artifact": spectron_semantic_translation_v338["artifact"],
            "network_contacted": spectron_semantic_translation_v338["network_contacted"],
            "summary": spectron_semantic_translation_v338["summary"],
            "carried_forward": spectron_semantic_translation_v338["carried_forward"]["target_feature_count"],
        },
        {
            "artifact": "spectron_semantic_function_translation",
            "network_contacted": False,
    ...
    check(
        "Spectron v338 feature export",
        {
            "artifact": spectron_features_v338["artifact"],
            "network_contacted": spectron_features_v338["network_contacted"],
            "function_count": spectron_features_v338["function_count"],
        },
        {
            "artifact": "ida_function_features",
            "network_contacted": False,
    ...
    check(
        "Spectron v338 checkpoint artifact",
        spectron_checkpoint_v338["artifact"],
        "spectron_translation_checkpoint_20260829_v338",
    )
    check(
        "Spectron v338 checkpoint parent",
        spectron_checkpoint_v338["parent_checkpoint"]["artifact"],
        "spectron_translation_checkpoint_20260829_v337",
    )
    check(
        "Spectron v338 checkpoint database",
        {
            "sha256": spectron_checkpoint_v338["database"]["sha256"],
            "close_reopen_verified": spectron_checkpoint_v338["database"]["close_reopen_verified"],
            "function_count": spectron_checkpoint_v338["database"]["function_count"],
            "default_name_count": spectron_checkpoint_v338["database"]["default_name_count"],
        },
        {
            "sha256": "26584982aa976361088e7978b162d12e1be4bf2bf9991bf9484c56e92bba8c2d",
            "close_reopen_verified": True,
            "function_count": 11707,
            "default_name_count": 0,
        },
    ...
    check(
        "Spectron v338 HTML-page lifecycle checkpoint",
        {
            "anchor_count": spectron_checkpoint_v338["html_page_lifecycle_translation_v338"]["anchor_count"],
            "high_confidence_count": spectron_checkpoint_v338["html_page_lifecycle_translation_v338"]["high_confidence_count"],
            "exact_metric_anchor_count": spectron_checkpoint_v338["html_page_lifecycle_translation_v338"]["exact_metric_anchor_count"],
            "layout_change_anchor_count": spectron_checkpoint_v338["html_page_lifecycle_translation_v338"]["layout_change_anchor_count"],
            "new_context_anchor_count": spectron_checkpoint_v338["html_page_lifecycle_translation_v338"]["new_context_anchor_count"],
            "semantic_promotion_count": spectron_checkpoint_v338["html_page_lifecycle_translation_v338"]["semantic_promotion_count"],
            "reopen_verified": spectron_checkpoint_v338["html_page_lifecycle_translation_v338"]["reopen_verified"],
        },
        {
            "anchor_count": 7,
            "high_confidence_count": 7,
    ...
    for document in (
        ...
        spectron_name_coverage_v321,
        spectron_dynamic_boundaries_v321,
        spectron_dynamic_symbol_coverage_v321,
        spectron_gui_missing_function_anchors_v321,
        spectron_semantic_translation_v320,
        original_dynamic_function_application_v321,
        spectron_checkpoint_v321,
        spectron_tgraalvar_runtime_gap_anchors_v322,
        spectron_name_coverage_v322,
        spectron_dynamic_boundaries_v322,
        spectron_dynamic_symbol_coverage_v322,
        spectron_checkpoint_v322,
        spectron_tgraalvar_runtime_continuation_anchors_v323,
        spectron_name_coverage_v323,
        spectron_dynamic_boundaries_v323,
        spectron_dynamic_symbol_coverage_v323,
        spectron_checkpoint_v323,
        spectron_tscript_runtime_anchors_v324,
        spectron_name_coverage_v324,
        spectron_dynamic_boundaries_v324,
        spectron_dynamic_symbol_coverage_v324,
        spectron_checkpoint_v324,
        spectron_tscript_destructor_anchors_v325,
        spectron_name_coverage_v325,
        spectron_dynamic_boundaries_v325,
        spectron_dynamic_symbol_coverage_v325,
        spectron_checkpoint_v325,
        spectron_tscript_space_residual_anchors_v329,
        spectron_tscript_space_residual_labels_v329,
        spectron_name_coverage_v329,
        spectron_dynamic_boundaries_v329,
        spectron_dynamic_symbol_coverage_v329,
        spectron_semantic_translation_v329,
        spectron_checkpoint_v329,
        spectron_tscript_universe_residual_anchors_v330,
        spectron_name_coverage_v330,
        spectron_dynamic_boundaries_v330,
        ...
        spectron_paneloperation_residual_anchors_v332,
        spectron_name_coverage_v332,
        spectron_dynamic_boundaries_v332,
        spectron_dynamic_symbol_coverage_v332,
        spectron_semantic_translation_v332,
        spectron_features_v332,
        spectron_checkpoint_v332,
        spectron_hashintvar_residual_anchors_v333,
        spectron_name_coverage_v333,
        spectron_dynamic_boundaries_v333,
        spectron_dynamic_symbol_coverage_v333,
        spectron_semantic_translation_v333,
        spectron_features_v333,
        spectron_checkpoint_v333,
        spectron_bitmap_jpeg_static_anchors_v334,
        spectron_name_coverage_v334,
        spectron_dynamic_boundaries_v334,
        spectron_dynamic_symbol_coverage_v334,
        spectron_semantic_translation_v334,
        spectron_features_v334,
        spectron_checkpoint_v334,
        spectron_adventure_static_residual_anchors_v335,
        spectron_name_coverage_v335,
        spectron_dynamic_boundaries_v335,
        spectron_dynamic_symbol_coverage_v335,
        spectron_semantic_translation_v335,
        spectron_features_v335,
        spectron_checkpoint_v335,
        spectron_format2_residual_anchors_v336,
        spectron_name_coverage_v336,
        spectron_dynamic_boundaries_v336,
        spectron_dynamic_symbol_coverage_v336,
        spectron_semantic_translation_v336,
        spectron_features_v336,
        spectron_checkpoint_v336,
        spectron_libjpeg_helper_residual_anchors_v337,
        spectron_name_coverage_v337,
        spectron_dynamic_boundaries_v337,
        spectron_dynamic_symbol_coverage_v337,
        spectron_semantic_translation_v337,
        spectron_features_v337,
        spectron_checkpoint_v337,
        spectron_html_page_lifecycle_anchors_v338,
        spectron_name_coverage_v338,
        spectron_dynamic_boundaries_v338,
        spectron_dynamic_symbol_coverage_v338,
        spectron_semantic_translation_v338,
        spectron_features_v338,
        spectron_checkpoint_v338,
    ):
