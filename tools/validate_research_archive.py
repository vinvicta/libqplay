...
def main():
    ...
    check("Spectron checkpoint database default sub count", spectron_checkpoint["database"]["default_sub_function_count"], 1457)
    ...
    check("Spectron checkpoint database hash", spectron_checkpoint["database"]["sha256"], "ea1cd81d0d6639959b0ddbf70d2f66ec20883fdd49e879ec077e61d8199a2b8d")
    check(
