#!/usr/bin/env python3
"""Verify the static CyaSSL aliases in an already saved IDA database."""
...
REPORT_PATH = Path("/tmp/cyassl_static_alias_verification_20260826.json")
...
def main() -> None:
    ...
    if result["status"] != "ok":
        raise RuntimeError("CyaSSL alias verification failed")
