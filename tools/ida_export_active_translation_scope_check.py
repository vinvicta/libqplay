...
OUTPUT = REPO / "artifacts" / "ida_active_translation_scope_check_20260830.json"
...
def main() -> None:
    ...
    result = {
        ...
        "interpretation": [
            "The 421 remaining default sub_ functions are outside the Android bridge callback region.",
