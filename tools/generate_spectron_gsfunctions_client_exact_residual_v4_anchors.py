#!/usr/bin/env python3
"""Create the fourth reviewed exact-shape GSFunctionsClient batch."""
...
EVIDENCE = [
    ...
    "The rows close the early Adventure and URL portion of the client table. Their readable script-facing names provide the role, while the table relocation ties each role to the target callback.",
...
ROWS = (
    (0x1564A0, "GSFunctionsClient_script_adventure_getwindowlist", 0x1592C8, "sub_1592C8", 0x378CD0),
    (0x1564A8, "GSFunctionsClient_script_adventure_reconnect", 0x1592D0, "sub_1592D0", 0x378EB0),
    (0x1564BC, "GSFunctionsClient_script_adventure_setgraalcontrolrecreate", 0x1592E4, "sub_1592E4", 0x378F40),
    (0x1564CC, "GSFunctionsClient_script_adventure_openexternalpm", 0x1592F4, "sub_1592F4", 0x378F70),
    (0x1564D4, "GSFunctionsClient_script_adventure_openexternaloptions", 0x1592FC, "sub_1592FC", 0x379000),
    (0x1564DC, "GSFunctionsClient_script_isfullscreenmode", 0x159304, "sub_159304", 0x379030),
    (0x156520, "GSFunctionsClient_script_adventure_setfullscreen", 0x159348, "sub_159348", 0x379060),
    (0x156554, "GSFunctionsClient_script_isofflinemode", 0x15937C, "sub_15937C", 0x379210),
    (0x156860, "GSFunctionsClient_get_isapplicationactive", 0x159688, "sub_159688", 0x378488),
    (0x156CB4, "GSFunctionsClient_script_openurl", 0x159ADC, "sub_159ADC", 0x379CC0),
    (0x156CF0, "GSFunctionsClient_script_openurl2", 0x159B18, "sub_159B18", 0x379CF0),
)
...
def main() -> None:
    ...
    original = by_ea(load(args.original_features)["functions"])
    spectron = by_ea(load(args.spectron_features)["functions"])
        ...
        anchors.append(
            {
                ...
                "confidence": "high",
                "match_kind": "manual-gsfunctions-client-table-relocation-exact-shape-v4",
                "semantic_match_already_present": False,
                "source_basis": "GSFunctionsClient callback table role %s" % source["name"],
                "context_group": "GSFunctionsClient exact residual callback batch v4",
                "context_order": order,
    ...
    result = {
        "schema_version": 1,
        "artifact": "spectron_gsfunctions_client_exact_residual_v4_manual_translation_anchors_20260826",
        "scope": "reviewed 1.8-to-Spectron ARM64 anchors for the fourth exact-shape GSFunctionsClient callback batch",
        ...
        "context": {
            "source_table_range": "0x378488 through 0x379cf0, with the rows kept in source table order",
            "target_table_range": "0x38b498 through 0x38d010, obtained by the verified +0x13010 relocation",
            "source_class": "GSFunctionsClient callback table",
            "target_class": "obfuscated Spectron GSFunctionsClient callback table",
            "coverage": "Adventure window and mode helpers, fullscreen state, application activity, and URL dispatch",
            "following_work": "the GSFunctionsClient callback-table residual audit is complete; other client symbols require separate class or protocol evidence",
        },
        "anchors": anchors,
        "interpretation": [
            ...
            "No target function boundaries were created in this batch because all eleven target addresses were already separate IDA functions.",
