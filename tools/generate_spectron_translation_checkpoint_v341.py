#!/usr/bin/env python3
"""Create the v341 checkpoint for the residual GuiControl color-setter pass."""
...
ARTIFACT = "spectron_translation_checkpoint_20260829_v341"
PARENT_ARTIFACT = "spectron_translation_checkpoint_20260829_v340"
EXPECTED_BINARY_SHA256 = "f57f7da48bcddf3738f15502328b36032313ad760eea04c5cc19ef82b4232219"
EXPECTED_PARENT_DATABASE_SHA256 = "24a96367fa0730d1a125d146f4fd8e304ba96f6676c15deb2807d085671734d1"
EXPECTED_DATABASE_SHA256 = "f892d0eb81a79a242c41aeb19742dc33693863fd0373217727d2bba154d33d73"
EXPECTED_ANCHOR_ARTIFACT = "spectron_colorset_residual_manual_translation_anchors_20260829"
...
EXPECTED_ALIASES = [
    "v18_GuiControl_setRed_float",
    "v18_GuiControl_setGreen_float",
    "v18_GuiControl_setBlue_float",
    "v18_GuiControl_setAlpha_float",
]
EXPECTED_TARGETS = ["0x1bea8c", "0x1bead0", "0x1beb14", "0x1beb58"]
EXPECTED_NAME_ORIGINS = {
    "ida_named_or_other": 4052,
    "target_jni_export": 7,
    "target_named_export": 800,
    "target_only_descriptive": 419,
    "translated_v18_alias": 6429,
}
EXPECTED_DYNAMIC_SUMMARY = {
    ...
    "name_match_counts": {
        "item_name_match": 1688,
        "item_name_mismatch": 5082,
        "value_name_match": 1688,
        "value_name_mismatch": 5082,
    },
    "named_dynamic_symbol_count": 6770,
    "status_counts": {
        "exact_retained_dynamic_name": 1688,
        "linker_boundary_alias_mismatch": 7,
        "other_retained_target_name": 120,
        "source_backed_v18_alias": 4783,
...
def main() -> None:
    ...
    require(parent["database"]["sha256"] == EXPECTED_PARENT_DATABASE_SHA256, "parent database hash is not v340")
    require(anchors.get("artifact") == EXPECTED_ANCHOR_ARTIFACT, "unexpected colorset anchor artifact")
    require(anchors.get("network_contacted") is False, "colorset anchors contacted the network")
    require(anchors.get("summary") == EXPECTED_ANCHOR_SUMMARY, "colorset anchor summary changed")
    require([row["proposed_name"] for row in anchors["anchors"]] == EXPECTED_ALIASES, "colorset alias order changed")
    require([row["spectron_ea"] for row in anchors["anchors"]] == EXPECTED_TARGETS, "colorset target order changed")
    require(
        ...
        "colorset alias application did not pass",
    )
    require(
        ...
        "colorset alias reopen verification did not pass",
    )
    require(
    ...
    require(
        ...
        "v341 dynamic boundary audit changed",
    )
    require(
        ...
        "v341 dynamic symbol coverage changed",
    )
    require(
        ...
        "v341 semantic map changed",
    )
    require(feature_export.get("function_count") == 11707, "v341 feature export count changed")
    require(args.database.is_file(), "database path is not a regular file")
    database_sha256 = sha256_path(args.database)
    require(database_sha256 == EXPECTED_DATABASE_SHA256, "v341 database hash changed")
    ...
    result["inputs"] = {
        **parent.get("inputs", {}),
        "v341_colorset_anchor_artifact": str(args.anchor_artifact),
        "v341_colorset_anchor_artifact_sha256": sha256_path(args.anchor_artifact),
        "v341_colorset_application_report": str(args.application_report),
        "v341_colorset_application_report_sha256": sha256_path(args.application_report),
        "v341_colorset_verification_report": str(args.verification_report),
        "v341_colorset_verification_report_sha256": sha256_path(args.verification_report),
        "v341_name_audit": str(args.name_audit),
        "v341_name_audit_sha256": sha256_path(args.name_audit),
        "v341_boundary_audit": str(args.boundary_audit),
        "v341_boundary_audit_sha256": sha256_path(args.boundary_audit),
        "v341_dynamic_symbol_coverage": str(args.dynamic_symbol_coverage),
        "v341_dynamic_symbol_coverage_sha256": sha256_path(args.dynamic_symbol_coverage),
        "v341_semantic_map": str(args.semantic_map),
        "v341_semantic_map_sha256": sha256_path(args.semantic_map),
        "v341_feature_export": str(args.feature_export),
        "v341_feature_export_sha256": sha256_path(args.feature_export),
    }
    result["colorset_translation_v341"] = {
    ...
    result["name_coverage_audit_v341"] = {
    ...
    result["dynamic_function_boundary_audit_v341"] = {
    ...
    result["dynamic_symbol_coverage_audit_v341"] = {
    ...
    result["semantic_function_translation_v341"] = {
    ...
    result["interpretation"].append(
        "The v341 pass adds four reviewed aliases for the residual GuiControl red, green, blue, and alpha setters."
    )
    result["interpretation"].append(
